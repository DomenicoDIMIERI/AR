...
using colorSpaces = org.dmdpdf.documents.contents.colorSpaces;
using org.dmdpdf.documents.contents.composition;
using entities = org.dmdpdf.documents.contents.entities;
...
using org.dmdpdf.documents.interaction.navigation.page;
      ...
      )
    {
      ...
      bookmarks.Add(
        bookmark = new Bookmark(
            document,
            "PDF Clown Home Page",
            new actions::GoToURI(document, new Uri("http://www.dmdpdf.org"))
            )
          );
      ...
      composer.BeginLocalState();
      {
        ...
        composer.BeginLocalState();
        {
            ...
            );
          {
            ...
            blockComposer.ShowText("For more info, visit http://www.dmdpdf.org");
          }
          blockComposer.End();
        }
        composer.End();
