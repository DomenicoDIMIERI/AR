  ...
  */
  public abstract class Sample
  {
    ...
    */
    ...
    {return _outputPath + (fileName != null ? Path.DirectorySeparatorChar + fileName : "");}
    ...
    */
    ...
    {
      string resourcePath = Path.GetFullPath(_inputPath + "pdf");
    ...
    */
      ...
      )
    {
      ...
      string outputFilePath = _outputPath + fileName + "." + serializationMode + ".pdf";
