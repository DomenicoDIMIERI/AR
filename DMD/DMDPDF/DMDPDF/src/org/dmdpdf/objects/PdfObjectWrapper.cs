  ...
  */
    ...
    : IPdfObjectWrapper
  {
    ...
    */
    ...
    #region dynamic
    #region fields
    private PdfDirectObject _baseObject;
    #endregion
    ...
    */
    ...
    {
      get
      {return _baseObject.DataContainer;}
    }
    ...
    */
    public virtual bool Delete() {
        ...
        if(_baseObject is PdfReference) { // Indirect object. 
            ((PdfReference)_baseObject).Delete();
            return true;
        } else { // Direct object.
                return false;
        }
    ...
    */
      ...
      )
    {
      return obj != null
        ...
        && ((PdfObjectWrapper)obj)._baseObject.Equals(_baseObject);
    }
    ...
    */
    ...
    private PdfDictionary Dictionary
    {
      get
      {
        ...
        if(baseDataObject is PdfDictionary) return baseDataObject as PdfDictionary;
        else if(baseDataObject is PdfStream) return (baseDataObject as PdfStream).Header;
        else return null;
      }
    }
    #endregion
