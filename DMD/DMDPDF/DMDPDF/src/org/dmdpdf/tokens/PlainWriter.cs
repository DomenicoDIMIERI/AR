...
namespace org.dmdpdf.tokens
{
  ...
  */
    ...
    : Writer
  {
    #region static
    #region fields
    private static readonly byte[] _TrailerChunk = Encoding.Pdf.Encode(Keyword.Trailer + Symbol.LineFeed);
    private static readonly string _XRefChunk = Keyword.XRef + Symbol.LineFeed;
    private static readonly string _XRefEOLChunk = "" + Symbol.CarriageReturn + Symbol.LineFeed;

    private const string _XRefGenerationFormat = "00000";
    private const string _XRefOffsetFormat = "0000000000";
    #endregion
    #endregion
      ...
      )
    {
      ...
      StringBuilder xrefBuilder = new StringBuilder(_XRefChunk);
      {
        /*
      ...
      )
    {
      ...
      return xrefBuilder.Append(offset.ToString(_XRefOffsetFormat)).Append(Symbol.Space)
        .Append(reference.GenerationNumber.ToString(_XRefGenerationFormat)).Append(Symbol.Space)
        .Append(usage).Append(_XRefEOLChunk);
    }
