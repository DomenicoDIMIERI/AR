            ...
            Select Case (predictor)
                Case 2 ' TIFF Predictor 2 (component-based).
                    ...
                    While (sampleComponentDelta <> -1)
                        ...
                        sampleComponentIndex = (sampleComponentIndex + 1) Mod sampleComponentsCount 'sampleComponentIndex = ++sampleComponentIndex % sampleComponentsCount
                        sampleComponentDelta = input.ReadByte()
                    End While
                    'break;
                Case Else ' PNG Predictors [RFC 2083] (byte-based).
                    ...
                    While (predictionMethod <> -1)
                        ...
                        For rowSampleByteIndex As Integer = sampleBytesCount To rowSampleBytesCount - 1 'rowSampleByteIndex++
