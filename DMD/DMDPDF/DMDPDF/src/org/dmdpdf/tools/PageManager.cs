  ...
  public sealed class PageManager
  {
    ...
    */
      ...
      )
    {
      ...
      ICollection<Page> importedPages = (ICollection<Page>)_document.Include(pages); // NOTE: Alien pages MUST be contextualized (i.e. imported).

      // Add the imported pages to the pages collection (shallow level)!
      this._pages.AddAll(importedPages);
    }
    ...
    */
      ...
      )
    {
      ...
      {this._pages.InsertAll(index, importedPages);}
    }
        ...
        */
        extractedDocument.Pages.AddAll(
          (ICollection<Page>)extractedDocument.Include(
            _pages.GetSlice(startIndex, endIndex)
            )
          );
      }
    ...
    */
      ...
      )
    {
      ...
      IList<Page> movingPages = _pages.GetSlice(startIndex, endIndex);
    ...
    */
    ...
    {
      IList<Page> removingPages = _pages.GetSlice(startIndex, endIndex);
