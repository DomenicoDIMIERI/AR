...
Namespace DMD.org.dmdpdf
    ...
    '*/
    Public Enum VersionEnum As Integer
        '/**
    ...
    Module VersionEnumExtension

        <Extension()>
        Public Function GetVersion(ByVal value As VersionEnum) As Version
            Dim versionSuffix As String = value.ToString().Substring(value.ToString().Length - 2)
