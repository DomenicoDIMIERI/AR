...
Namespace DMD.org.dmdpdf.documents
    ...
    Public NotInheritable Class NamedJavaScripts
        Inherits NameTree(Of JavaScript)
...
#Region "Protected"
        ...
        Protected Overrides Function WrapValue(ByVal baseObject As PdfDirectObject) As JavaScript
            Return CType(Interaction.actions.Action.Wrap(baseObject), JavaScript)
        End Function
