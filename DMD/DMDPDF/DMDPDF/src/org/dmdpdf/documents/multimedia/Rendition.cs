...
using org.dmdpdf.documents.interchange.access;
        ...
        get
        {
          ...
          return pdfVersionArray != null && pdfVersionArray.Count > 0
            ? new Interval<Version>(
              org.dmdpdf.Version.Get((PdfName)pdfVersionArray[0]),
              pdfVersionArray.Count > 1 ? org.dmdpdf.Version.Get((PdfName)pdfVersionArray[1]) : null
              )
            : null;
        }
      }
