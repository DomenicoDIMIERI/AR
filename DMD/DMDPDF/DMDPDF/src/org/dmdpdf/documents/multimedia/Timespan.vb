...
Namespace DMD.org.dmdpdf.documents.multimedia
    ...
    Friend NotInheritable Class Timespan
...
#Region "constructors"
        ...
        Public Sub New(ByVal time As Double)
            MyBase.New(New PdfDictionary(New PdfName() {PdfName.Type, PdfName.S}, New PdfDirectObject() {PdfName.Timespan, PdfName.S}))
            Me.Time = time
        End Sub
...
#Region "public"
        ...
        Public Property Time As Double
            Get
                Return CType(BaseDataObject(PdfName.V), IPdfNumber).DoubleValue
            End Get
