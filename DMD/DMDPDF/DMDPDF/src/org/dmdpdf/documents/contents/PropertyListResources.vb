...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Public NotInheritable Class PropertyListResources
        Inherits ResourceItems(Of PropertyList)
...
#Region "Protected"
        ...
        Protected Overrides Function Wrap(ByVal baseObject As PdfDirectObject) As PropertyList
