...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Public NotInheritable Class ColorSpaceResources
        Inherits ResourceItems(Of ColorSpace)
...
#Region "Protected"
        ...
        Protected Overrides Function Wrap(ByVal baseObject As PdfDirectObject) As ColorSpace
