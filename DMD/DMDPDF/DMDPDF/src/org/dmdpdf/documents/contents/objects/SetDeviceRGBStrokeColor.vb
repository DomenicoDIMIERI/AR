...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class SetDeviceRGBStrokeColor
        Inherits SetStrokeColor

#Region "Static"
#Region "fields"

        Public Shared Shadows ReadOnly OperatorKeyword As String = "RG" 'New 
...
#Region "constructors"
        ...
        Public Sub New(ByVal value As DeviceRGBColor)
