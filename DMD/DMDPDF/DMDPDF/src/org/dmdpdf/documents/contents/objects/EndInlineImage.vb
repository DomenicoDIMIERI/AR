...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class EndInlineImage
        Inherits Operation

#Region "Static"
#Region "fields"

        Public Shared ReadOnly OperatorKeyword As String = "EI"

        Public Shared ReadOnly Value As EndInlineImage = New EndInlineImage()
