...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Public NotInheritable Class XObjectResources
        Inherits ResourceItems(Of XObject)
...
#Region "Protected"
        ...
        Protected Overrides Function Wrap(ByVal baseObject As PdfDirectObject) As XObject
