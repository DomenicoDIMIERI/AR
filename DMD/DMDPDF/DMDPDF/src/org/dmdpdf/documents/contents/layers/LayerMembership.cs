...
namespace org.dmdpdf.documents.contents.layers
{
  /**
  ...
  */
    ...
    : LayerEntity
  {
    ...
    */
    ...
    {
      #region fields
      private LayerMembership _membership;
      #endregion
        ...
        )
      {
        ...
        if(!(baseDataObject is PdfArray))
        {
          ...
          if(baseDataObject != null) {array.Add(baseDataObject);}
    ...
    #region static
    #region fields
    public static PdfName _TypeName = PdfName.OCMD;
    #endregion
