...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class MarkedContentPoint
        Inherits ContentMarker

#Region "Static"
#Region "fields"

        Public Shared ReadOnly PropertyListOperatorKeyword As String = "DP"
        Public Shared ReadOnly SimpleOperatorKeyword As String = "MP"
