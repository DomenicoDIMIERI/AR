...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class SetLineJoin
        Inherits Operation
...
#Region "constructors"
        ...
        Public Sub New(ByVal value As LineJoinEnum)
...
#Region "Public"
        ...
        Public Overrides Sub Scan(ByVal state As ContentScanner.GraphicsState)
            state.LineJoin = Me.Value
        End Sub

        Public Property Value As LineJoinEnum
            Get
                Return CType(CType(Me._operands(0), IPdfNumber).Value, LineJoinEnum)
            End Get
