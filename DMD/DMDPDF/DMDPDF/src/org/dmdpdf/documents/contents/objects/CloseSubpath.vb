...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class CloseSubpath
        Inherits Operation

#Region "Static"
#Region "fields"

        Public Shared ReadOnly OperatorKeyword As String = "h"

        Public Shared ReadOnly Value As CloseSubpath = New CloseSubpath()
