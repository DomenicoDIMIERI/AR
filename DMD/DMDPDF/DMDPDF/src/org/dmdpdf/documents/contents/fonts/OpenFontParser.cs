  ...
  */
  internal sealed class OpenFontParser
  {
    ...
    */
    ...
    private Dictionary<string,int> _tableOffsets;
    #endregion
    ...
    */
      ...
      )
    {
      ...
      */
      ...
      int tableOffset;
      if(!_tableOffsets.TryGetValue("cmap", out tableOffset))
    ...
    */
      ...
      )
    {
      ...
      // Retrieve the location info!
      int tableOffset;
      if(!_tableOffsets.TryGetValue("name", out tableOffset))
    ...
    */
      ...
      )
    {
      ...
      // Retrieve the location info!
      int tableOffset;
      if(!_tableOffsets.TryGetValue("kern", out tableOffset))
    ...
    */
      ...
      )
    {
      ...
      // Retrieve the location info!
      int tableOffset;
      if(!_tableOffsets.TryGetValue("hmtx", out tableOffset))
      ...
      )
    {
      ...
      _tableOffsets = new Dictionary<string,int>(tableCount);
      for(
        int index = 0;
        index < tableCount;
        index++
    ...
    */
      ...
      )
    {
      // Font Header ('head' table).
      int tableOffset;
      if(!_tableOffsets.TryGetValue("head", out tableOffset))
      ...
      if(_tableOffsets.TryGetValue("OS/2", out tableOffset))
      {
        FontData.Seek(tableOffset);
      ...
      // Horizontal Header ('hhea' table).
      if(!_tableOffsets.TryGetValue("hhea", out tableOffset))
      ...
      if(!_tableOffsets.TryGetValue("post", out tableOffset))
