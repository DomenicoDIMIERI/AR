    ...
    */
      ...
      : PdfObjectWrapper<PdfDictionary>
    {
      ...
      */
      ...
      #region static
      #region fields
      private static readonly Dictionary<RelationEnum,PdfName> _RelationEnumCodes;
      #endregion

      #region constructors
      static PathElement()
      {
        _RelationEnumCodes = new Dictionary<RelationEnum,PdfName>();
      ...
      */
      ...
      {
        foreach(KeyValuePair<RelationEnum,PdfName> relation in _RelationEnumCodes)
        {
