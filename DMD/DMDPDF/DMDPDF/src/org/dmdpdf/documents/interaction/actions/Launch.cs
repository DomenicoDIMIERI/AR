    ...
    */
      ...
      : PdfObjectWrapper<PdfDictionary>
    {
      ...
      */
      ...
      #region static
      #region fields
      private static readonly Dictionary<OperationEnum,PdfString> _OperationEnumCodes;
      #endregion

      #region constructors
      static WinTarget()
      {
        _OperationEnumCodes = new Dictionary<OperationEnum,PdfString>();
      ...
      */
      ...
      {
        foreach(KeyValuePair<OperationEnum,PdfString> operation in _OperationEnumCodes)
        {
