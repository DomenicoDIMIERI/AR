...
Namespace DMD.org.dmdpdf.documents.interaction.actions
    ...
    Public NotInheritable Class PlaySound
        Inherits Action
...
#Region "constructors"
        ...
        '*/
        Public Sub New(ByVal context As Document, ByVal sound As Sound)
            MyBase.New(context, PdfName.Sound)
            Me.Sound = Sound
        End Sub
...
#Region "public"
        ...
        Public Property Sound As Sound
            Get
                ...
                '*/
                Return New Sound(BaseDataObject(PdfName.Sound))
            End Get
            Set(ByVal value As Sound)
                If (value Is Nothing) Then Throw New ArgumentException("Sound MUST be defined.")
