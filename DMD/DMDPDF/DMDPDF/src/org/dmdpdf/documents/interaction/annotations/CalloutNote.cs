        ...
        get
        {
          ...
          if(coordinates.Count < 6)
            return new PointF(
              ...
              (float)(_page.Box.Height - ((IPdfNumber)coordinates[3]).RawValue)
              );
          else
            return new PointF(
              (float)((IPdfNumber)coordinates[4]).RawValue,
              (float)(_page.Box.Height - ((IPdfNumber)coordinates[5]).RawValue)
              );
        }
      }
      ...
      public PointF Start
      {
        get
        {
          ...
          return new PointF(
            ...
            (float)(_page.Box.Height - ((IPdfNumber)coordinates[1]).RawValue)
            );
        }
      }
      #endregion
