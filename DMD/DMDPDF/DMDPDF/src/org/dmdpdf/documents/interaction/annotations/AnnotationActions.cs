    ...
    */
      ...
      )
    {
      return BaseDataObject.ContainsKey(key)
        || (PdfName.A.Equals(key) && _parent.BaseDataObject.ContainsKey(key));
    }
    ...
    {
      if(PdfName.A.Equals(key) && _parent.BaseDataObject.ContainsKey(key))
      {
        OnActivate = null;
        return true;
      }
    ...
    {
      get
      {return BaseDataObject.Count + (_parent.BaseDataObject.ContainsKey(PdfName.A) ? 1 : 0);}
    }
