  ...
  */
    ...
    : Annotation
  {
    ...
    */
    ...
    #region static
    #region fields
    private static readonly Dictionary<HighlightModeEnum,PdfName> _HighlightModeEnumCodes;
    #endregion

    #region constructors
    static Widget()
    {
      _HighlightModeEnumCodes = new Dictionary<HighlightModeEnum,PdfName>();
    ...
    */
    ...
    {
      foreach(KeyValuePair<HighlightModeEnum,PdfName> mode in _HighlightModeEnumCodes)
      {
