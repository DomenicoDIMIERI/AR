...
Namespace DMD.org.dmdpdf.util.collections.generic
    ...
    '*/
    Public Interface IExtCollection(Of T)
        ...
        '*/
        Sub AddAll(Of TVar As T)(ByVal items As ICollection(Of TVar))
        ...
        '*/
        Sub RemoveAll(Of TVar As T)(ByVal items As ICollection(Of TVar))
