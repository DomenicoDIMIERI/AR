...
#Region "constructors"
        Friend Sub New(ByVal file As File, ByVal xrefEntries As SortedDictionary(Of Integer, XRefEntry))
            ...
            If (Me._xrefEntries Is Nothing) Then ' No Then original Indirect objects.
...
#Region "public"
        ...
        Public Function AddExternal(ByVal obj As PdfIndirectObject, ByVal cloner As Cloner) As PdfIndirectObject
            ...
            If (Not _importedObjects.TryGetValue(obj.GetHashCode(), indirectObject)) Then
                ...
                _importedObjects.Add(obj.GetHashCode(), indirectObject)
...
#Region "IList"
        ...
        Public Function IndexOf(ByVal obj As PdfIndirectObject) As Integer Implements IList(Of PdfIndirectObject).IndexOf
            ...
            If (obj.File IsNot _file) Then Return -1
        ...
        Public Sub RemoveAt(ByVal index As Integer) Implements IList(Of PdfIndirectObject).RemoveAt
            If (Me(index).IsInUse()) Then
                ...
                '  New objects are assigned New numbers [PDF:1.6:H0000000.3:       16].
        ...
        Default Public Property Item(ByVal index As Integer) As PdfIndirectObject Implements IList(Of PdfIndirectObject).Item
            Get
...
#Region "ICollection"
        ...
        Public Sub Clear() Implements ICollection(Of PdfIndirectObject).Clear
            Dim length As Integer = Me.Count
        ...
        Public Sub CopyTo(ByVal objs As PdfIndirectObject(), ByVal index As Integer) Implements ICollection(Of PdfIndirectObject).CopyTo
            Throw New NotSupportedException()
        End Sub
        ...
        '*/
        Public ReadOnly Property Count As Integer Implements ICollection(Of PdfIndirectObject).Count
            Get
                Return _lastObjectNumber + 1
            End Get
        End Property

        Public ReadOnly Property IsReadOnly As Boolean Implements ICollection(Of PdfIndirectObject).IsReadOnly
            Get
                Return False
            End Get
        End Property
        ...
        Public Function Remove(ByVal obj As PdfIndirectObject) As Boolean Implements ICollection(Of PdfIndirectObject).Remove
            If (Not Contains(obj)) Then Return False
