...
namespace org.dmdpdf.tokens
{
  ...
  */
      ...
      IDictionary<int,PdfDataObject>
  {
    ...
    {
      internal PdfDataObject _dataObject;
        ...
        ) : this(parser)
      {
        ...
        this._offset = -1; // Undefined -- to set on stream serialization.
      }
      ...
      public PdfDataObject DataObject
      {
        get
        {
          if(_dataObject == null)
          {
            _parser.Seek(_offset); _parser.MoveNext();
    ...
    */
    private IDictionary<int,ObjectEntry> _entries;
    private FileParser _parser;
    #endregion
    ...
    */
    ...
    {
      if(_entries == null)
      {_entries = new Dictionary<int,ObjectEntry>();}
      else
      {_entries.Clear();}
    }
      ...
      get
      {
        if(_entries == null)
        {
          ...
          if(body.Length > 0)
          {
            ...
            {
              int objectNumber = ((PdfInteger)_parser.ParsePdfObject(1)).IntValue;
              int objectOffset = baseOffset + ((PdfInteger)_parser.ParsePdfObject(1)).IntValue;
