...
#Region "types"
        ...
        Private Class PageFilter
            ...
            Public Overrides Function Matches(ByVal cloner As Cloner, ByVal obj As PdfObject) As Boolean
                Return TypeOf (obj) Is PdfDictionary AndAlso
                        PdfName.Page.Equals(CType(obj, PdfDictionary)(PdfName.Type))
            End Function
...
#Region "fields"
        ...
        Private Shared _commonFilters As IList(Of Filter) = New List(Of Filter)()
...
#Region "Public"
        ...
        Public Overrides Function Visit(ByVal obj As PdfStream, ByVal data As Object) As PdfObject
            ...
            '{
            clone._header = CType(Visit(obj._header, data), PdfDictionary)
            clone._body = obj._body.Clone()
            '}
            Return clone
        End Function
