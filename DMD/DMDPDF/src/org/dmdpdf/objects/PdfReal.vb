...
Namespace DMD.org.dmdpdf.objects
    ...
    '*/
    Public NotInheritable Class PdfReal
        Inherits PdfSimpleObject(Of Double)
        Implements IPdfNumber

#Region "Static"
#Region "fields"
        Private Shared ReadOnly formatInfo As NumberFormatInfo
#End Region
...
#Region "public"
        ...
        '*/
        Public Shared Shadows Function [Get](ByVal value As Double?) As PdfReal
            If (Not value.HasValue) Then Return Nothing
            Dim doubleValue As Double = value.Value
            If (Double.IsNaN(doubleValue)) Then Return Nothing
