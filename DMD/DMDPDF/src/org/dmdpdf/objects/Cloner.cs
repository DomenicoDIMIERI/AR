...
namespace org.dmdpdf.objects
{
  ...
  */
    ...
    : Visitor
  {
    ...
    #region static
    #region fields
    private static readonly Filter _NullFilter = new Filter("Default");

    private static IList<Filter> _commonFilters = new List<Filter>();
    #endregion
    ...
    private readonly IList<Filter> _filters = new List<Filter>(_commonFilters);
    #endregion
    ...
    {return _context.IndirectObjects.AddExternal(obj, this);}
    ...
    {
      Filter cloneFilter = _NullFilter;
