...
#Region "constructors"
        ...
        Public Sub New(ByVal context As Document)
            MyBase.New(context, New PdfDictionary(New PdfName() {PdfName.Type}, New PdfDirectObject() {PdfName.MediaPlayerInfo}))
        End Sub
...
#Region "public"
        ...
        '*/
        Public Property Identifier As SoftwareIdentifier
            Get
                Return SoftwareIdentifier.Wrap(BaseDataObject.Get(Of PdfDictionary)(PdfName.PID))
            End Get
            Set(ByVal value As SoftwareIdentifier)
