...
using org.dmdpdf.documents.interaction;
...
namespace org.dmdpdf.documents.multimedia
{
  ...
  */
  ...
  {
    private static readonly BiDictionary<MediaScreenParameters.Viability.FloatingWindowParametersObject.LocationEnum,PdfInteger> _codes;

    static LocationEnumExtension()
    {
      _codes = new BiDictionary<MediaScreenParameters.Viability.FloatingWindowParametersObject.LocationEnum,PdfInteger>();
      ...
      )
    {
      ...
      MediaScreenParameters.Viability.FloatingWindowParametersObject.LocationEnum? location = _codes.GetKey(code);
  ...
  {
    private static readonly BiDictionary<MediaScreenParameters.Viability.FloatingWindowParametersObject.OffscreenBehaviorEnum,PdfInteger> _codes;

    static OffscreenBehaviorEnumExtension()
    {
      _codes = new BiDictionary<MediaScreenParameters.Viability.FloatingWindowParametersObject.OffscreenBehaviorEnum,PdfInteger>();
      ...
      )
    {
      ...
      MediaScreenParameters.Viability.FloatingWindowParametersObject.OffscreenBehaviorEnum? offscreenBehavior = _codes.GetKey(code);
  ...
  {
    private static readonly BiDictionary<MediaScreenParameters.Viability.FloatingWindowParametersObject.RelatedWindowEnum,PdfInteger> _codes;

    static RelatedWindowEnumExtension()
    {
      _codes = new BiDictionary<MediaScreenParameters.Viability.FloatingWindowParametersObject.RelatedWindowEnum,PdfInteger>();
      ...
      )
    {
      ...
      MediaScreenParameters.Viability.FloatingWindowParametersObject.RelatedWindowEnum? relatedWindow = _codes.GetKey(code);
