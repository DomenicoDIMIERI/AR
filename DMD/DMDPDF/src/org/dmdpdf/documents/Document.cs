...
using org.dmdpdf.documents.interaction.forms;
using org.dmdpdf.documents.interaction.navigation.document;
using org.dmdpdf.documents.interchange.metadata;
using org.dmdpdf.documents.interaction.viewer;
...
namespace org.dmdpdf.documents
{
  /**
  ...
  */
    ...
    : PdfObjectWrapper<PdfDictionary>
  {
    ...
    */
    public sealed class ConfigurationImpl
    {
      ...
      */
      ...
      private CompatibilityModeEnum _compatibilityMode = CompatibilityModeEnum.Loose;
      private XRefModeEnum _xrefMode = XRefModeEnum.Plain;

      private Document _document;

      internal ConfigurationImpl( Document document )
      ...
      */
      public XRefModeEnum XrefMode
      {
        ...
        {return _xrefMode;}
        set
        {_document.CheckCompatibility(_xrefMode = value);}
      }
    }
    ...
    */
    ...
    #region dynamic
    #region fields
    internal Dictionary<PdfReference,object> _Cache = new Dictionary<PdfReference,object>();
  ...
  {
    private static readonly BiDictionary<Document.PageLayoutEnum,PdfName> _codes;

    static PageLayoutEnumExtension()
    {
      _codes = new BiDictionary<Document.PageLayoutEnum,PdfName>();
      ...
      )
    {
      ...
      Document.PageLayoutEnum? pageLayout = _codes.GetKey(name);
  ...
  {
    private static readonly BiDictionary<Document.PageModeEnum,PdfName> _codes;

    static PageModeEnumExtension()
    {
      _codes = new BiDictionary<Document.PageModeEnum,PdfName>();
      ...
      )
    {
      ...
      Document.PageModeEnum? pageMode = _codes.GetKey(name);
