...
Namespace DMD.org.dmdpdf.documents.interaction.actions
    ...
    Public NotInheritable Class GoToLocal
        Inherits GoToDestination(Of LocalDestination)
...
#Region "constructors"
        ...
        '*/
        Public Sub New(ByVal context As Document, ByVal destination As LocalDestination)
            MyBase.New(context, PdfName.GoTo, destination)
        End Sub
