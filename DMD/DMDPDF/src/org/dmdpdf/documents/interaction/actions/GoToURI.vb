...
Namespace DMD.org.dmdpdf.documents.interaction.actions
    ...
    Public NotInheritable Class GoToURI
        Inherits Action
...
#Region "constructors"
        ...
        '*/
        Public Sub New(ByVal context As Document, ByVal uri As Uri)
            MyBase.New(context, PdfName.URI)
            Me.URI = Uri
        End Sub
...
#Region "public"
        ...
        Public Property URI As Uri
            Get
                ...
                '*/
                Return New Uri(CStr(CType(Me.BaseDataObject(PdfName.URI), PdfString).Value))
            End Get
            Set(ByVal value As Uri)
                Me.BaseDataObject(PdfName.URI) = New PdfString(value.ToString())
            End Set
        End Property
