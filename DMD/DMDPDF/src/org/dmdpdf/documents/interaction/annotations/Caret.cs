  ...
  */
    ...
    : Annotation
  {
    ...
    */
    ...
    #region static
    #region fields
    private static readonly Dictionary<SymbolTypeEnum,PdfName> _SymbolTypeEnumCodes;
    #endregion

    #region constructors
    static Caret()
    {
      _SymbolTypeEnumCodes = new Dictionary<SymbolTypeEnum,PdfName>();
    ...
    */
    ...
    {
      foreach(KeyValuePair<SymbolTypeEnum,PdfName> symbolType in _SymbolTypeEnumCodes)
      {
