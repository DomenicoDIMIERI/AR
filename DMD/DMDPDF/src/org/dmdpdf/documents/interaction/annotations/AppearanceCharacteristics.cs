    ...
    */
      ...
      : PdfObjectWrapper<PdfDictionary>
    {
      ...
      */
      ...
      #region static
      #region fields
      private static readonly Dictionary<ScaleModeEnum,PdfName> _ScaleModeEnumCodes;
      private static readonly Dictionary<ScaleTypeEnum,PdfName> _ScaleTypeEnumCodes;
      #endregion

      #region constructors
      static IconFitObject()
      {
        _ScaleModeEnumCodes = new Dictionary<ScaleModeEnum,PdfName>();
        ...
        _ScaleTypeEnumCodes = new Dictionary<ScaleTypeEnum,PdfName>();
      ...
      */
      ...
      {
        foreach(KeyValuePair<ScaleModeEnum,PdfName> scaleMode in _ScaleModeEnumCodes)
        {
      ...
      */
      ...
      {
        foreach(KeyValuePair<ScaleTypeEnum,PdfName> scaleType in _ScaleTypeEnumCodes)
        {
