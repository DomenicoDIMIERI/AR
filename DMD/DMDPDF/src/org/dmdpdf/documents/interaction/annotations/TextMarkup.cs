  ...
  */
    ...
    : Annotation
  {
    ...
    */
    ...
    #region static
    #region fields
    private static readonly Dictionary<MarkupTypeEnum,PdfName> _MarkupTypeEnumCodes;
    #endregion

    #region constructors
    static TextMarkup()
    {
      _MarkupTypeEnumCodes = new Dictionary<MarkupTypeEnum,PdfName>();
    ...
    */
    ...
    {
      foreach(KeyValuePair<MarkupTypeEnum,PdfName> markupType in _MarkupTypeEnumCodes)
      {
    ...
    */
    public MarkupTypeEnum MarkupType
    {
      ...
      set
      {
        ...
        switch(value)
        {
          case MarkupTypeEnum.Highlight: Color = new DeviceRGBColor(1, 1, 0);
            break;
    ...
    */
      ...
      )
    {
      ...
      RectangleF box = org.dmdpdf.objects.Rectangle.Wrap(BaseDataObject[PdfName.Rect]).ToRectangleF();
      {
