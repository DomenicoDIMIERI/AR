...
//     else if(annotationType.Equals(PdfName.3DAnnotation)) return new 3DAnnotation(baseObject);
    ...
    */
    public RectangleF Box
    {
      get
      {
        org.dmdpdf.objects.Rectangle box = org.dmdpdf.objects.Rectangle.Wrap(BaseDataObject[PdfName.Rect]);
      ...
      set
      {
        BaseDataObject[PdfName.Rect] = new org.dmdpdf.objects.Rectangle(
          value.X,
