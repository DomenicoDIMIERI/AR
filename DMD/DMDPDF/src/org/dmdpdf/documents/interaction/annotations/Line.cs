  ...
  */
    ...
    : Annotation
  {
    ...
    */
    ...
    #region static
    #region fields
    private static readonly double _DefaultLeaderLineExtensionLength = 0;
    private static readonly double _DefaultLeaderLineLength = 0;
    private static readonly LineEndStyleEnum _DefaultLineEndStyle = LineEndStyleEnum.None;

    private static readonly Dictionary<LineEndStyleEnum,PdfName> _LineEndStyleEnumCodes;
    #endregion

    #region constructors
    static Line()
    {
      _LineEndStyleEnumCodes = new Dictionary<LineEndStyleEnum,PdfName>();
    ...
    */
    ...
    {
      foreach(KeyValuePair<LineEndStyleEnum,PdfName> style in _LineEndStyleEnumCodes)
      {
    ...
    public double LeaderLineExtensionLength
    {
      get
      {
        ...
        return leaderLineExtensionLengthObject != null
          ...
          : _DefaultLeaderLineExtensionLength;
      }
      set
      {
