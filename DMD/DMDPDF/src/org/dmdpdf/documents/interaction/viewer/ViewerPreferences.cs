...
namespace org.dmdpdf.documents.interaction.viewer
{
  /**
  ...
  */
    ...
    : PdfObjectWrapper<PdfDictionary>
  {
    ...
    */
    ...
    #region static
    #region fields
    private static readonly Dictionary<DirectionEnum,PdfName> _DirectionEnumCodes;
    #endregion

    #region constructors
    static ViewerPreferences()
    {
      _DirectionEnumCodes = new Dictionary<DirectionEnum,PdfName>();
    ...
    */
    ...
    {
      foreach(KeyValuePair<DirectionEnum,PdfName> direction in _DirectionEnumCodes)
      {
