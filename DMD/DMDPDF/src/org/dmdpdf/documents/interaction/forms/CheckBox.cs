...
namespace org.dmdpdf.documents.interaction.forms
{
  /**
    ...
    */
    ...
    public bool Checked
    {
      get
      {
        ...
        return !(value == null || value.Equals(PdfName.Off_));
      }
      set
      {
        ...
        */
        ...
        if(value)
        {
          ...
          if(appearanceDictionary != null)
          {
            ...
            {
              if(!appearanceKey.Equals(PdfName.Off_))
              {
    ...
    public override object Value
    {
      ...
      {return base.Value;}
      set
      {Checked = !(value == null || value.Equals(String.Empty) || value.Equals(PdfName.Off_.Value));}
    }
    #endregion
    #endregion
    #endregion
