...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Public NotInheritable Class ShadingResources 'sealed
        Inherits ResourceItems(Of Shading)
...
#Region "Protected"
        ...
        Protected Overrides Function Wrap(ByVal baseObject As PdfDirectObject) As Shading
