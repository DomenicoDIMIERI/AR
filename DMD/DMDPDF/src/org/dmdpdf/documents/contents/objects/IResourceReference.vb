...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    '*/
    Public Interface IResourceReference(Of TResource As PdfObjectWrapper)
        '/**
        ...
        '*/
        Function GetResource(ByVal context As IContentContext) As TResource
