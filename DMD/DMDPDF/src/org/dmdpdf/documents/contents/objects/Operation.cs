...
namespace org.dmdpdf.documents.contents.objects
{
  /**
  ...
  */
    ...
    : ContentObject
  {
    ...
    */
    ...
    #region dynamic
    #region fields
    protected string _operator_;
    protected IList<PdfDirectObject> _operands;
    #endregion
      ...
      )
    {
      ...
      this._operands = new List<PdfDirectObject>();
    ...
    {
      this._operator_ = operator_;
      this._operands = new List<PdfDirectObject>(operands);
    }
      ...
      )
    {
      if(_operands != null)
      {
        ...
        foreach(PdfDirectObject operand in _operands)
        {operand.WriteTo(stream, fileContext); stream.Write(Chunk.Space);}
      }
      stream.Write(_operator_); stream.Write(Chunk.LineFeed);
    }
    #endregion
    #endregion
    #endregion
