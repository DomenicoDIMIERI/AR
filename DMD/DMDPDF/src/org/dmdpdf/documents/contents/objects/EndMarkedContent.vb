...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class EndMarkedContent
        Inherits Operation

#Region "Static"
#Region "fields"

        Public Shared ReadOnly OperatorKeyword As String = "EMC"

        Public Shared ReadOnly Value As EndMarkedContent = New EndMarkedContent()
