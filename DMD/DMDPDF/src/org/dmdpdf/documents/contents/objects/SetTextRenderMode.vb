...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class SetTextRenderMode
        Inherits Operation

#Region "Static"
#Region "fields"

        Public Shared ReadOnly OperatorKeyword As String = "Tr"
...
#Region "constructors"
        ...
        Public Sub New(ByVal value As TextRenderModeEnum)
...
#Region "Public"
        ...
        Public Overrides Sub Scan(ByVal state As ContentScanner.GraphicsState)
            state.RenderMode = Me.Value
        End Sub

        Public Property Value As TextRenderModeEnum
            Get
                Return CType(CType(Me._operands(0), IPdfNumber).Value, TextRenderModeEnum)
            End Get
