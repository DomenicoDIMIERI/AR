...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class TranslateTextToNextLine
        Inherits Operation

#Region "Static"
#Region "fields"

        Public Shared ReadOnly OperatorKeyword As String = "T*"

        Public Shared ReadOnly Value As TranslateTextToNextLine = New TranslateTextToNextLine()
...
#Region "Public"
        ...
        Public Overrides Sub Scan(ByVal state As ContentScanner.GraphicsState)
            state.Tlm.Translate(0, CSng(state.Lead))
