...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class SetDeviceCMYKStrokeColor
        Inherits SetStrokeColor

#Region "Static"
#Region "fields"

        Public Shared Shadows ReadOnly OperatorKeyword As String = "K"
...
#Region "constructors"
        ...
        Public Sub New(ByVal value As DeviceCMYKColor)
