...
Namespace DMD.org.dmdpdf.documents.contents.objects
    ...
    Public NotInheritable Class BeginInlineImage
        Inherits Operation

#Region "Static"
#Region "fields"

        Public Shared ReadOnly OperatorKeyword As String = "BI"

        Public Shared ReadOnly Value As BeginInlineImage = New BeginInlineImage()
