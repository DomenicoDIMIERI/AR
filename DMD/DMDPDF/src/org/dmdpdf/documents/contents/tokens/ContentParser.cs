...
namespace org.dmdpdf.documents.contents.tokens
{
  /**
      ...
      )
    {
      switch(TokenType)
      {
        case TokenTypeEnum.Literal:
          if(Token is string) return new PdfString( Encoding.Pdf.Encode((string)Token), PdfString.SerializationModeEnum.Literal );
          break;
