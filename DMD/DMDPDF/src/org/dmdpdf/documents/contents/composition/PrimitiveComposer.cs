...
using objects = org.dmdpdf.documents.contents.objects;
...
using org.dmdpdf.util.math.geom;
  ...
  public sealed class PrimitiveComposer
  {
    ...
    */
      ...
      )
    {
      ...
      if(!_scanner.ContentContext.Resources.ExtGStates.ContainsKey(name))
    ...
    */
      ...
      )
    {
      ...
      if(propertyListName != null && !_scanner.ContentContext.Resources.PropertyLists.ContainsKey(propertyListName))
    ...
    */
    ...
    {
      double contextHeight = _scanner.ContentContext.Box.Height;
      Add(
    ...
    */
      ...
      )
    {
      ...
      Translate(
        origin.X,
        _scanner.ContentContext.Box.Height - origin.Y
        );
      ...
      Translate(
        0,
        -_scanner.ContentContext.Box.Height
        );
    }
    ...
    */
    ...
    {
      if(!_scanner.State.FillColorSpace.Equals(value.ColorSpace))
      {
    ...
    */
    public void SetFont(PdfName name, double size ) {
      ...
      if(!_scanner.ContentContext.Resources.Fonts.ContainsKey(name)) throw new ArgumentException("No font resource associated to the given argument.","name");
      SetFont_(name,size);
    }
    ...
    */
    ...
    {
      if(!_scanner.State.StrokeColorSpace.Equals(value.ColorSpace))
      {
    ...
    */
    ...
    {
      ContentScanner.GraphicsState state = _scanner.State;
        ...
        && yAlignment == YAlignmentEnum.Top)
      {
        ...
        try
        {
          if(rotation == 0)
          {
            TranslateText(
              x,
              _scanner.ContentContext.Box.Height - y - font.GetAscent(fontSize)
              );
          }
          else
          {
      ...
      else
      {
        ...
        try
        {
          ...
          ApplyMatrix(
            ...
            cos,
            x,
            _scanner.ContentContext.Box.Height - y
            );
    ...
    */
    ...
    {
      IContentContext contentContext = _scanner.ContentContext;
    ...
    */
    ...
    {
      XObject xObject = _scanner.ContentContext.Resources.XObjects[name];
      ...
      try
      {
        Translate(
          location.X,
          _scanner.ContentContext.Box.Height - location.Y
          );
        if(rotation != 0)
        {Rotate(rotation);}
        ApplyMatrix(
    ...
    */
    ...
    private PdfName GetResourceName<T>(T value) where T : PdfObjectWrapper
    {
      if(value is colors::DeviceGrayColorSpace)
        ...
        PdfDictionary resourceItemsObject = ((PdfObjectWrapper<PdfDictionary>)_scanner.ContentContext.Resources.Get(value.GetType())).BaseDataObject;
