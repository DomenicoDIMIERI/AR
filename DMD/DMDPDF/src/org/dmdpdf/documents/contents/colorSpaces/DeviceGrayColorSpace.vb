...
Namespace DMD.org.dmdpdf.documents.contents.colorSpaces
    ...
    Public NotInheritable Class DeviceGrayColorSpace
...
#Region "fields"
        ...
        '*/
        Public Shared ReadOnly [Default] As DeviceGrayColorSpace = New DeviceGrayColorSpace(PdfName.DeviceGray)
...
#Region "constructors"
        ...
        Public Sub New(ByVal context As Document)
            MyBase.new(context, PdfName.DeviceGray)
        End Sub
...
#Region "Public"
        ...
        Public Overrides Function GetPaint(ByVal color As Color) As Drawing.Brush
            Dim spaceColor As DeviceGrayColor = CType(color, DeviceGrayColor)
            Dim g As Integer = CInt(Math.Round(spaceColor.G * 255))
