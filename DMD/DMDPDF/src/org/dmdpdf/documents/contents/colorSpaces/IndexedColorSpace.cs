...
namespace org.dmdpdf.documents.contents.colorSpaces
{
  /**
  ...
  */
    ...
    : SpecialColorSpace
  {
    #region dynamic
    #region fields
    private IDictionary<int,Color> _baseColors = new Dictionary<int,Color>();
    private byte[] _baseComponentValues;
    private ColorSpace _baseSpace;
    #endregion
    ...
    */
    public ColorSpace BaseSpace
    {
      ...
      {
        if(_baseSpace == null)
        {_baseSpace = ColorSpace.Wrap(((PdfArray)BaseDataObject)[1]);}
        return _baseSpace;
      }
    }
    ...
    */
      ...
      )
    {
      ...
      Color baseColor = _baseColors[colorIndex];
      if(baseColor == null)
      {
    ...
    */
    private byte[] BaseComponentValues
    {
      get
      {
        if(_baseComponentValues == null)
        {_baseComponentValues = ((IDataWrapper)((PdfArray)BaseDataObject).Resolve(3)).ToByteArray();}
