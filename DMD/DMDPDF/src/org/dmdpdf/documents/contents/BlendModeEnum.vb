...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Module BlendModeEnumExtension

        Private ReadOnly codes As BiDictionary(Of BlendModeEnum?, PdfName)

        Sub New()
            codes = New BiDictionary(Of BlendModeEnum?, PdfName)
        ...
        Public Function [Get](ByVal name As PdfName) As BlendModeEnum?
            Return codes.GetKey(name)
        End Function

        <Extension>
        Public Function GetName(ByVal blendMode As BlendModeEnum) As PdfName
