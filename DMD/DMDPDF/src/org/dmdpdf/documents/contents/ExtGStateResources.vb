...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Public NotInheritable Class ExtGStateResources
        Inherits ResourceItems(Of ExtGState)
...
#Region "Protected"
        ...
        Protected Overrides Function Wrap(ByVal baseObject As PdfDirectObject) As ExtGState
