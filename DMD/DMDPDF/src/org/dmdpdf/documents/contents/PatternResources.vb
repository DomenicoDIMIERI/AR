...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Public NotInheritable Class PatternResources
        Inherits ResourceItems(Of Pattern)
...
#Region "Protected"
        ...
        Protected Overrides Function Wrap(ByVal baseObject As PdfDirectObject) As Pattern
