...
Namespace DMD.org.dmdpdf.documents.contents
    ...
    Module LineJoinEnumExtension 'Static 

        <Extension>
        Public Function ToGdi(ByVal value As LineJoinEnum) As LineJoin 'this
            Select Case (value)
                ...
                Case Else
                    Throw New NotSupportedException(value.ToString & " convertion not supported.")
            End Select
        End Function
