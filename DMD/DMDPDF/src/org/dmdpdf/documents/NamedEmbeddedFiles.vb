...
Namespace DMD.org.dmdpdf.documents
    ...
    Public NotInheritable Class NamedEmbeddedFiles
        Inherits NameTree(Of FileSpecification)
...
#Region "Protected"
        ...
        Protected Overrides Function WrapValue(ByVal baseObject As PdfDirectObject) As FileSpecification
