  ...
  public sealed class TextExtractor
  {
    ...
    */
    ...
    private class IntervalFilter
      : IIntervalFilter
    {
      private IList<Interval<int>> m_intervals;

      private IList<ITextString> m_textStrings = new List<ITextString>();
      ...
      {return (++m_index < m_intervals.Count);}

      public void Process(
        Interval<int> interval,
        ITextString match
        )
      {m_textStrings.Add(match);}
    ...
    */
    private class TextString
      ...
      : ITextString
    {
      private List<TextChar> m_textChars = new List<TextChar>();
      ...
      public RectangleF? Box
      {
        ...
        {
          RectangleF? box = null;
          foreach(TextChar textChar in m_textChars)
          {
            if(!box.HasValue)
    ...
    */
    ...
    #region dynamic
    #region fields
    private AreaModeEnum m_areaMode = AreaModeEnum.Containment;
    private List<RectangleF> m_areas;
    private float m_areaTolerance = 0;
    private bool m_dehyphenated;
    ...
    */
    ...
    {
      get{return m_areaMode;}
      set{m_areaMode = value;}
    }
    ...
    */
    public IList<RectangleF> Areas
    {
      ...
      {return m_areas;}
      set
      {m_areas = (value == null ? new List<RectangleF>() : new List<RectangleF>(value));}
    }
    ...
    */
    ...
    {
      get
      {return m_areaTolerance;}
      set
      {m_areaTolerance = value;}
    }
    ...
    */
    ...
    {
      get
      {return m_dehyphenated;}
      set
      {
        m_dehyphenated = value;
        if(m_dehyphenated)
        {Sorted = true;}
      }
    }
    ...
    */
      ...
      )
    {
      ...
      foreach(RectangleF area in areas)
      {
        ...
        RectangleF toleratedArea = (m_areaTolerance != 0
          ? new RectangleF(
            area.X - m_areaTolerance,
            area.Y - m_areaTolerance,
            area.Width + m_areaTolerance * 2,
            area.Height + m_areaTolerance * 2
            )
          : area);
        foreach(ITextString textString in textStrings)
        {
          ...
          if(toleratedArea.IntersectsWith(textStringBox.Value))
          {
            ...
            foreach(TextChar textChar in textString.TextChars)
            {
              ...
              if((m_areaMode == AreaModeEnum.Containment && toleratedArea.Contains(textCharBox))
                || (m_areaMode == AreaModeEnum.Intersection && toleratedArea.IntersectsWith(textCharBox)))
