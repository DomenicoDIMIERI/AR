        ...
        )
      {
        ...
        switch(printerSettings.PrintRange)
        {
          case PrintRange.SomePages:
            if(_pageIndex < printerSettings.FromPage)
            {_pageIndex = printerSettings.FromPage;}
            else
            {_pageIndex++;}

            e.HasMorePages = (_pageIndex < printerSettings.ToPage);
            break;
          default:
            _pageIndex++;

            e.HasMorePages = (_pageIndex+1 < _pagesCount);
            break;
        }
