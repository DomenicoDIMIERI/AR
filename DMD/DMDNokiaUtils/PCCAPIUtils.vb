...
Module PCCAPIUtils
    ...
    Public Sub ShowErrorMessage(ByRef strError As String, ByRef errorCode As Integer)
        ...
        ' MsgBox(strMessage)
        Throw New Nokia.NokiaException(errorCode, strError)
    End Sub
    ...
    Public Function GetLocalFormattedDate(ByVal dwTime As System.Runtime.InteropServices.ComTypes.FILETIME) As Date?
