...
DMDWHPPChatMessage.prototype.parseDiv = function (div) {
    ...
    if (classes.indexOf("msg-system")>=0) {
        ...
        switch (div.innerText.toUpperCase().trim()) {
            case "I MESSAGGI CHE INVII IN QUESTA CHAT E LE CHIAMATE SONO PROTETTI CON LA CRITTOGRAFIA ENDTOEND.":
            case "I MESSAGGI CHE INVII IN QUESTA CHAT E LE CHIAMATE SONO PROTETTI CON LA CRITTOGRAFIA END-TO-END.":
            case "I MESSAGGI CHE INVII IN QUESTA CHAT E LE CHIAMATE SONO PROTETTI CON LA CRITTOGRAFIA ENDTOEND.":
                break;
            default:
                this.Chat.ChatTime = parseDate(div.innerText);
        }
