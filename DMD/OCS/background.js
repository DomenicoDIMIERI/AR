 ...
 */
var DEBUG = true;
//var SERVICEURL = "http://localhost:3016/bd/ocshack.aspx"; //The service to notify conversations
var SERVICEURL = "http://areariservata.finsea.net/bd/ocshack.aspx"; //The service to notify conversations
var SERVICEUSERNAME = "Fin.Se.A. Srl";                     //A preshared key to identify the destination 
var SERVICENUMBER = "3711312982";                          //A preshared key to identify the destination 
