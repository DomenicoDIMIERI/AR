...
Namespace FinSeA
    ...
    Public Class DBConnection
        ...
        Public Sub New()
            ...
            Me.m_LockingMode = OleDbLockMode.NotSet
        ...
        Public Sub Open()
            Me.Connection = Me.CreateConnection
            Me.Connection.Open()
        End Sub
        ...
        Public Function CreateAdapter(selectCommand As String) As IDataAdapter
            Return New System.Data.OleDb.OleDbDataAdapter(selectCommand, Me.Connection)
        End Function

        Public Function CreateCommand(ByVal sql As String) As IDbCommand
            Dim cmd As System.Data.IDbCommand = Me.Connection.CreateCommand
            cmd.CommandText = sql
            Return cmd
        End Function

        'Protected Function GetTablesArray() As CDBTable()
        ...
        '    Dim cmd As System.Data.OleDb.OleDbCommand = table.GetUpdateCommand(changedValues)
        ...
        '    Dim tableName As String = Me.GetSaveTableName(obj)
        '    Dim table As CDBTable = Me.Tables(tableName)
        '    Dim cmd As System.Data.OleDb.OleDbCommand = table.GetInsertCommand
        ...
        Function ExecuteScalar(ByVal dbSQL As String) As Integer
        ...
        Sub ExecuteCommand(ByVal dbSQL As String)
            Dim dbCmd As System.Data.IDbCommand = Nothing
            dbSQL = Trim(dbSQL)
            dbCmd = Me.CreateCommand(dbSQL)
