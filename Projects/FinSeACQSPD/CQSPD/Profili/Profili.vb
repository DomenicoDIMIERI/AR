...
Partial Public Class CQSPD
    ...
    Public NotInheritable Class CProfiliClass
        ...
        ''' <remarks></remarks>
        Public Sub GetPreventivatoriPerUtente( _
                            ByVal user As CUser, _
                            ByRef items() As CProfilo, _
                            ByRef arrIDs() As Integer, _
                            ByRef arrAllow() As Boolean, _
                            ByRef arrNegate() As Boolean _
                            )
