...
Partial Public Class CQSPD
    ...
    Public Class CGruppoProdotti
        ...
        Private m_Documenti As CDocumentiXGruppoProdottiCollection
        ...
        Public Overrides Function GetModule() As CModule
            Return DMD.CQSPD.GruppiProdotto.Module
        End Function
        ...
        Protected Overrides Function SaveToDatabase(dbConn As CDBConnection, force As Boolean) As Boolean
            ...
            If (ret AndAlso Me.m_Documenti IsNot Nothing) Then Me.m_Documenti.Save()
            Return ret
        End Function

        Protected Overrides Sub OnAfterSave(e As SystemEvent)
            MyBase.OnAfterSave(e)
            CQSPD.GruppiProdotto.UpdateCached(Me)
        End Sub
