...
Partial Public Class CQSPD
    ...
    Public NotInheritable Class CPraticheClass
            ...
            While (stato IsNot Nothing)
                If (stato.GiorniStallo.HasValue) Then
                    ...
                    While Not cursor.EOF
                        ...
                        If (Math.Abs(Calendar.DateDiff(DateInterval.Day, d1, Now)) > stato.GiorniStallo) Then
        ...
        Function CalcolaProssimaDecorrenza() As Date
            Return Me.CalcolaProssimaDecorrenza(Calendar.ToDay)
        End Function

        Function CalcolaProssimaDecorrenza(ByVal fromDate As Date) As Date
            Dim ret As Date = fromDate
            If (ret.Day <= 15) Then
                ret = Calendar.MakeDate(ret.Year, ret.Month, 15)
            Else
                ret = Calendar.GetNextMonthFirstDay(ret)
            End If
            Return ret
        End Function
            ...
            While (stato IsNot Nothing)
                ...
                ElseIf (stato.GiorniStallo.HasValue) Then
                    ...
                    While Not cursor.EOF
                        ...
                        If (d1.HasValue AndAlso Math.Abs(Calendar.DateDiff(DateInterval.Day, d1.Value, Now)) > stato.GiorniStallo) Then
                            ret.Add(pratica)
                        End If
                        cursor.MoveNext()
                    End While
