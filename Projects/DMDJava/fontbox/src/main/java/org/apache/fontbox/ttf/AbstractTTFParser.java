...
abstract class AbstractTTFParser {
    ...
    throws IOException {
        List(Of TTFTable) initialized = new ArrayList(Of TTFTable)();
        ...
        {
            // in an embedded font Me table is optional
        ...
        Iterator(Of TTFTable) iter = font.getTables().iterator();
        while( iter.hasNext() )
        {
        ...
        if ( font.getGlyph() Is Nothing )
        {
            throw new IOException("glyf is mandatory");
        }
        if ( font.getNaming() Is Nothing && !isEmbedded )
        {
            throw new IOException("name is mandatory");
        }
        if ( font.getHorizontalMetrics() Is Nothing )
        {
