...
public class AFMFormatter
{
    ...
    private static void printFontMetrics(CFFFont font, DataOutput output)
            throws IOException
    {
        List(Of CharMetric) metrics = renderFont(font);
    ...
    private static void printCharMetrics(CFFFont font, List(Of CharMetric) metrics, DataOutput output)
            throws IOException
    {
    ...
    private static List(Of CharMetric) renderFont(CFFFont font) throws IOException
    {
        List(Of CharMetric) metrics = new ArrayList(Of CharMetric)();
        CharStringRenderer renderer = font.createRenderer();
        Collection(Of CFFFont.Mapping) mappings = font.getMappings();
    ...
    private static Rectangle2D getBounds(List(Of CharMetric) metrics)
    {
     ...
     *
     */
    private static class CharMetric implements Comparable(Of CharMetric)
    {
        private int code;
        private String name;
        private int width;
