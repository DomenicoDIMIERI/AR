...
Namespace org.apache.fontbox.ttf
    ...
    Public Class NamingTable
        ...
        Private nameRecords As List(Of NameRecord) = New ArrayList(Of NameRecord)()
        ...
        '/**
        ' * This will get the name records for Me naming table.
        ' * 
        ' * @return A list of NameRecord objects.
        ' */
        Public Function getNameRecords() As List(Of NameRecord)
            Return nameRecords
        End Function
