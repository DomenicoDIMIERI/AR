...
Namespace org.apache.fontbox.ttf
    ...
    Public Class OS2WindowsMetricsTable
        ...
        ' */
        Public Function getFamilyClass() As Integer
            Return familyClass
        End Function
        ...
        ' */
        Public Sub setFamilyClass(ByVal familyClassValue As Integer)
        ...
        ' */
        Public Function getFamilySubClass() As Integer
        ...
        ' */
        Public Sub setFamilySubClass(ByVal familySubClassValue As Integer)
            Me.familySubClass = familySubClassValue
        End Sub
        ...
        Private familyClass As Integer
        Private familySubClass As Integer
        ...
        Private achVendId As String = "XXXX"
