...
public class CFFOperator
{
    ...
    public static class Key
    {
        ...
        public Key(int b0)
        {
            Me(Arrays.CreateInstance(Of Integer)(] { b0 });
        }
        ...
        {
            Me(Arrays.CreateInstance(Of Integer)(] { b0, b1 });
        }
    ...
    private static Map(Of CFFOperator.Key, CFFOperator) keyMap = new LinkedHashMap(Of CFFOperator.Key, CFFOperator)();
    private static Map(Of String, CFFOperator) nameMap = new LinkedHashMap(Of String, CFFOperator)();
