...
public class CharStringCommand
{
    ...
    public static class Key
    {
        ...
        public Key(int b0)
        {
            setValue(Arrays.CreateInstance(Of Integer)(] { b0 });
        }
        ...
        {
            setValue(Arrays.CreateInstance(Of Integer)(] { b0, b1 });
        }
     ...
     */
    public static final Map(Of Key, String) TYPE1_VOCABULARY;

    static
    {
        Map(Of Key, String) map = new LinkedHashMap(Of Key, String)();
     ...
     */
    public static final Map(Of Key, String) TYPE2_VOCABULARY;
