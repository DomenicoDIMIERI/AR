...
public abstract class Encoding
{
     ...
     */
    public static Map(Of String,NInteger) MAC_GLYPH_NAMES_INDICES;
     ...
     */
    protected Map(Of NInteger,String) codeToName = new HashMap(Of NInteger,String)();
    /**
     * This is a mapping from a character name to a character code.
     */
    protected Map(Of String,NInteger) nameToCode = new HashMap(Of String,NInteger)();

    private static final Map(Of String,String) NAME_TO_CHARACTER = new HashMap(Of String,String)();
    private static final Map(Of String,String) CHARACTER_TO_NAME = new HashMap(Of String,String)();
