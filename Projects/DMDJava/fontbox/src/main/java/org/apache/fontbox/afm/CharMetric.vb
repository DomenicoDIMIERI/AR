...
Namespace org.apache.fontbox.afm
    ...
    Public Class CharMetric
        ...
        Private ligatures As List(Of Ligature) = New ArrayList(Of Ligature)
        ...
        ' */
        Public Function getLigatures() As List(Of Ligature)
            Return ligatures
        End Function
        ...
        ' */
        Public Sub setLigatures(ByVal lig As List(Of Ligature))
            Me.ligatures = lig
        End Sub
