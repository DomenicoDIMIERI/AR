...
public class GlyfCompositeDescript extends GlyfDescript
{
    ...
    private List(Of GlyfCompositeComp) components = new ArrayList(Of GlyfCompositeComp)();
    ...
    public void resolve()
    {
        ...
        Iterator(Of GlyfCompositeComp) i = components.iterator();
        while (i.hasNext())
        {
    ...
    {
        if (glyphs IsNot Nothing && index < glyphs.length)
        {
            GlyphData glyph = glyphs(index);
            if (glyph IsNot Nothing)
            {
