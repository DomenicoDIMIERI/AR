Imports System.IO
Imports FinSeA.org.fontbox.encoding
...
Namespace org.fontbox.ttf
    ...
    Public Class PostScriptTable
        ...
        Public Overrides Sub initData(ByVal ttf As TrueTypeFont, ByVal data As TTFDataStream)
            ...
            Dim encoding As New MacRomanEncoding()
            ...
            If (formatType = 1.0F) Then
                ...
                ' * Macintosh TrueType.
                ' */
                glyphNames = Array.CreateInstance(GetType(String), 258)
                For i As Integer = 0 To glyphNames.Length - 1
                    Dim name As String = encoding.getName(i)
            ...
            ElseIf (formatType = 2.0F) Then
                ...
                If (maxIndex >= 258) Then
                    nameArray = Array.CreateInstance(GetType(String), maxIndex - 258 + 1)
                    For i As Integer = 0 To maxIndex - 258 + 1 - 1
                        Dim numberOfChars As Integer = data.read()
                ...
                For i As Integer = 0 To numGlyphs - 1
                    ...
                    ElseIf (index >= 258 AndAlso index <= 32767) Then
            ...
            ElseIf (formatType = 2.5F) Then
                ...
                For i As Integer = 0 To glyphNames.Length - 1
                    Dim name As String = encoding.getName(glyphNameIndex(i))
                    If (name <> vbNullString) Then
                        glyphNames(i) = name
                    End If
                Next
