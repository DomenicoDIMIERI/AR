...
Namespace org.fontbox.afm
    ...
    Public Class FontMetric
        ...
        Private comments As FinSeA.List = New FinSeA.ArrayList()
        ...
        Private charMetrics As FinSeA.List = New FinSeA.ArrayList()
        Private charMetricsMap As FinSeA.Map = New FinSeA.HashMap()
        Private trackKern As FinSeA.List = New FinSeA.ArrayList()
        Private composites As FinSeA.List = New FinSeA.ArrayList()
        Private kernPairs As FinSeA.List = New FinSeA.ArrayList()
        Private kernPairs0 As FinSeA.List = New FinSeA.ArrayList()
        Private kernPairs1 As FinSeA.List = New FinSeA.ArrayList()
        ...
        ' * @throws IOException If this AFM file does not handle the character.
        ' */
        Public Function getAverageCharacterWidth() As Single
            Dim average As Single = 0
            Dim totalWidths As Single = 0
            Dim characterCount As Single = 0
            For Each metric As CharMetric In charMetricsMap.Values ' Iterator iter = charMetricsMap.values().iterator();
                '        While (iter.hasNext())
                '{
        ...
        ' */
        Public Function getComments() As FinSeA.List
            Return comments
        End Function
        ...
        ' */
        Public Sub setIsBaseFont(ByVal isBaseFontValue As Boolean)
            Me._isBaseFont = isBaseFontValue
        End Sub
        ...
        ' */
        Public Function getCharMetrics() As FinSeA.List
            Return charMetrics
        End Function
        ...
        ' */
        Public Sub setCharMetrics(ByVal charMetricsValue As FinSeA.List)
        ...
        ' */
        Public Function getTrackKern() As FinSeA.List
            Return trackKern
        End Function
        ...
        ' */
        Public Sub setTrackKern(ByVal trackKernValue As FinSeA.List)
        ...
        ' */
        Public Function getComposites() As FinSeA.List
            Return composites
        End Function
        ...
        ' */
        Public Sub setComposites(ByVal compositesList As FinSeA.List)
        ...
        ' */
        Public Function getKernPairs() As FinSeA.List
            Return kernPairs
        End Function
        ...
        ' */
        Public Sub setKernPairs(ByVal kernPairsList As FinSeA.List)
        ...
        ' */
        Public Function getKernPairs0() As FinSeA.List
            Return kernPairs0
        End Function
        ...
        ' */
        Public Sub setKernPairs0(ByVal kernPairs0List As FinSeA.List)
        ...
        ' */
        Public Function getKernPairs1() As FinSeA.List
            Return kernPairs1
        End Function
        ...
        ' */
        Public Sub setKernPairs1(ByVal kernPairs1List As FinSeA.List)
