Namespace Drawings
    ...
    Public Interface Shape
        ...
        '            the calculations to accurately determine Me intersection are prohibitively expensive. 
        '        This means that for some Shapes Me method might return true even though the rectangular area does not intersect the Shape. The Area class performs more accurate computations of geometric intersection than most Shape objects and therefore can be used if a more precise answer is required.
        ...
        '            the calculations to accurately determine Me intersection are prohibitively expensive. 
        '        This means that for some Shapes Me method might return true even though the Rectangle2D does not intersect the Shape. The Area class performs more accurate computations of geometric intersection than most Shape objects and therefore can be used if a more precise answer is required.
        ...
        '        This means that for some Shapes Me method might return false even though the Shape contains the rectangular area. The Area class performs more accurate geometric computations than most Shape objects and therefore can be used if a more precise answer is required.
        ...
        '        This means that for some Shapes Me method might return false even though the Shape contains the Rectangle2D. The Area class performs more accurate geometric computations than most Shape objects and therefore can be used if a more precise answer is required.
        ...
        '        Each call to Me method returns a fresh PathIterator object that traverses the Shape object geometry independently from any other PathIterator objects in use at the same time.
