...
public class Type2CharStringParser
{
     ...
     */
    public List(Of Object) parse(byte[] bytes, IndexData globalSubrIndex, IndexData localSubrIndex) throws IOException
    {
    	return parse(bytes, globalSubrIndex, localSubrIndex, true);
    }
    
    private List(Of Object) parse(byte[] bytes, IndexData globalSubrIndex, IndexData localSubrIndex, boolean init) throws IOException
    {
        if (init) 
        {
	        hstemCount = 0;
        ...
        boolean localSubroutineIndexProvided = localSubrIndex IsNot Nothing && localSubrIndex.getCount() > 0;
        boolean globalSubroutineIndexProvided = globalSubrIndex IsNot Nothing && globalSubrIndex.getCount() > 0;
    ...
    private CharStringCommand readCommand(int b0, DataInput input) throws IOException
    {
        ...
        {
            int[] value = Arrays.CreateInstance(Of Integer)(1 + getMaskLength()];
            value(0) = b0;
