...
public class CharStringConverter extends CharStringHandler
{
    ...
    private List(Of Object) sequence = null;
     ...
     */
    public List(Of Object) convert(List(Of Object) commandSequence)
    {
     ...
     */
    @Override
    public List(Of NInteger) handleCommand(List(Of NInteger) numbers, CharStringCommand command)
    {
    ...
    private List(Of NInteger) handleType1Command(List(Of NInteger) numbers,
    ...
    private List(Of NInteger) handleType2Command(List(Of NInteger) numbers,
            CharStringCommand command)
    {
        String name = CharStringCommand.TYPE2_VOCABULARY.get(command.getKey());
        if ("hflex".equals(name))
        {
            List(Of NInteger) first = Arrays.asList(numbers.get(0), NInteger.valueOf(0), 
                    numbers.get(1), numbers.get(2), numbers.get(3), NInteger.valueOf(0));
            List(Of NInteger) second = Arrays.asList(numbers.get(4), NInteger.valueOf(0), 
                    numbers.get(5), NInteger.valueOf(-numbers.get(2).intValue()), 
                    numbers.get(6), NInteger.valueOf(0));
            addCommandList(Arrays.asList(first, second), new CharStringCommand(8));
        } 
        else if ("flex".equals(name))
        {
            List(Of NInteger) first = numbers.subList(0, 6);
            List(Of NInteger) second = numbers.subList(6, 12);
            addCommandList(Arrays.asList(first, second), new CharStringCommand(8));
        }
        else if ("hflex1".equals(name))
        {
            List(Of NInteger) first = Arrays.asList(numbers.get(0), numbers.get(1), 
                    numbers.get(2), numbers.get(3), numbers.get(4), NInteger.valueOf(0));
            List(Of NInteger) second = Arrays.asList(numbers.get(5), NInteger.valueOf(0),
                    numbers.get(6), numbers.get(7), numbers.get(8), NInteger.valueOf(0));
            addCommandList(Arrays.asList(first, second), new CharStringCommand(8));
        }
        else if ("flex1".equals(name))
        {
            ...
            List(Of NInteger) first = numbers.subList(0, 6);
            List(Of NInteger) second = Arrays.asList(numbers.get(6), numbers.get(7), numbers.get(8), 
                    numbers.get(9), (Math.abs(dx) > Math.abs(dy) ? numbers.get(10) : NInteger.valueOf(-dx)), 
                    (Math.abs(dx) > Math.abs(dy) ? NInteger.valueOf(-dy) : numbers.get(10)));
            addCommandList(Arrays.asList(first, second), new CharStringCommand(8));
        }
    ...
    private List(Of NInteger) clearStack(List(Of NInteger) numbers, boolean flag)
    {
        ...
        if (sequence.size() == 0)
        {
            if (flag)
            {
                addCommand(Arrays.asList(NInteger.valueOf(0), Integer
    ...
    private void expandStemHints(List(Of NInteger) numbers, boolean horizontal)
    {
        // TODO
    }
    ...
    private void closePath()
    {
        ...
        if (command IsNot Nothing && !closepathCommand.equals(command))
        {
            addCommand(Collections.(Of NInteger) emptyList(), closepathCommand);
        }
    }

    private void drawAlternatingLine(List(Of NInteger) numbers, boolean horizontal)
    {
    ...
    private void drawAlternatingCurve(List(Of NInteger) numbers, boolean horizontal)
    {
        while (numbers.size() > 0)
        {
            ...
            if (horizontal)
            {
                addCommand(Arrays.asList(numbers.get(0), NInteger.valueOf(0),
                        numbers.get(1), numbers.get(2), last ? numbers.get(4)
                                : NInteger.valueOf(0), numbers.get(3)),
                        new CharStringCommand(8));
            } 
            else
            {
                addCommand(Arrays.asList(NInteger.valueOf(0), numbers.get(0),
                        numbers.get(1), numbers.get(2), numbers.get(3),
                        last ? numbers.get(4) : NInteger.valueOf(0)),
                        new CharStringCommand(8));
            }
    ...
    private void drawCurve(List(Of NInteger) numbers, boolean horizontal)
    {
        while (numbers.size() > 0)
        {
            ...
            if (horizontal)
            {
                addCommand(Arrays.asList(numbers.get(first ? 1 : 0),
                        first ? numbers.get(0) : NInteger.valueOf(0), numbers
                                .get(first ? 2 : 1),
                        numbers.get(first ? 3 : 2), numbers.get(first ? 4 : 3),
                        NInteger.valueOf(0)), new CharStringCommand(8));
            } 
            else
            {
                addCommand(Arrays.asList(first ? numbers.get(0) : Integer
                        ...
                        NInteger.valueOf(0), numbers.get(first ? 4 : 3)),
                        new CharStringCommand(8));
            }
    ...
    private void addCommandList(List(Of List(Of NInteger)) numbers,
            CharStringCommand command)
    {
    ...
    private void addCommand(List(Of NInteger) numbers, CharStringCommand command)
    {
