...
public class CharStringRenderer extends CharStringHandler
{
     ...
     */
    public GeneralPath render(List(Of Object) sequence)
    {
     ...
     * @param command
     */
    private void handleCommandType2(List(Of NInteger) numbers, CharStringCommand command)
    {
        ...
        {
            if (path.getCurrentPoint() IsNot Nothing)
            {
                closePath();
            }
        ...
        else if ("hmoveto".equals(name)) //
        {
            ...
            {
                setWidth(numbers.get(0));
                rmoveTo(numbers.get(1), NInteger.valueOf(0));
            }
            else
            {
     ...
     * @param command
     */
    private void handleCommandType1(List(Of NInteger) numbers, CharStringCommand command)
    {
        ...
        {
            rrcurveTo(NInteger.valueOf(0), numbers.get(0), numbers.get(1),
                    numbers.get(2), numbers.get(3), NInteger.valueOf(0));
        }
        else if ("hvcurveto".equals(name))
        {
            rrcurveTo(numbers.get(0), NInteger.valueOf(0), numbers.get(1),
                    numbers.get(2), NInteger.valueOf(0), numbers.get(3));
        }
    }
    ...
    private void hlineTo(List(Of NInteger) numbers)
    {
    ...
    private void vlineTo(List(Of NInteger) numbers)
    {
        for (int i = 0;i < numbers.size();i++)
        {
            if (i % 2 == 0)
    ...
    private void rrlineTo(List(Of NInteger) numbers)
    {
    ...
    private void rrCurveTo(List(Of NInteger) numbers)
    {
        if (numbers.size() >= 6)
        {
    ...
    private void rlineCurve(List(Of NInteger) numbers)
    {
        if (numbers.size() >= 6)
        {
            if (numbers.size() - 6 > 0)
    ...
    private void rcurveLine(List(Of NInteger) numbers)
    {
        for (int i = 0;i < numbers.size();i += 6)
        {
            if (numbers.size() - i < 6)
    ...
    private void rvhCurveTo(List(Of NInteger) numbers)
    {
    ...
    private void rhvCurveTo(List(Of NInteger) numbers)
    {
        boolean smallCase = numbers.size() <= 5;
        boolean odd = numbers.size() % 2 != 0;
        if ((!odd) ? numbers.size() % 4 == 0 : (numbers.size() -1) % 4 == 0)
    ...
    private void rhhCurveTo(List(Of NInteger) numbers)
    {
        boolean odd = numbers.size() % 2 != 0;
        if ((!odd) ? numbers.size() % 4 == 0 : (numbers.size() -1) % 4 == 0)
        {
    ...
    private void rvvCurveTo(List(Of NInteger) numbers)
    {
        boolean odd = numbers.size() % 2 != 0;
        if ((!odd) ? numbers.size() % 4 == 0 : (numbers.size() -1) % 4 == 0)
        {
