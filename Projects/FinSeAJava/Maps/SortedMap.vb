Namespace java
    ...
    Public Interface SortedMap
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function headMap(ByVal toKey As Object) As SortedMap
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function subMap(ByVal fromKey As Object, ByVal toKey As Object) As SortedMap
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function tailMap(ByVal fromKey As Object) As SortedMap
