Namespace java
    ...
    Public Interface SortedMap(Of TKey, TValue)
        Inherits SortedMap, Map(Of TKey, TValue)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shadows Function comparator() As Global.System.Collections.Generic.IComparer(Of TKey)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shadows Function firstKey() As TKey
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shadows Function headMap(ByVal toKey As TKey) As SortedMap(Of TKey, TValue)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shadows Function lastKey() As TKey
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shadows Function subMap(ByVal fromKey As TKey, ByVal toKey As TKey) As SortedMap(Of TKey, TValue)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Shadows Function tailMap(ByVal fromKey As TKey) As SortedMap(Of TKey, TValue)
