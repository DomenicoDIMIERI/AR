...
Partial Class WebSite
    ...
    Public Class WebServiceEx
        ...
        Protected Overrides Sub InternalRender(writer As HtmlTextWriter)
            ...
            '    Dim ret As String = Me.ExecuteAction(Me.RequestedAction, Me)
            '    writer.Write("00" & Me.SanitarizeResponse(ret))
            'Else
            Try
                Dim ret As String = Me.ExecuteAction(Me.RequestedAction, Me)
                writer.Write(Me.SanitarizeResponse("00" & ret))
            Catch ex As Exception
                ...
                writer.Write(Me.SanitarizeResponse("01" & TypeName(ex) & vbNewLine & ex.Message)) '& vbNewLine & ex.StackTrace)
            End Try
            'End If

        End Sub

        Protected Overridable Function SanitarizeResponse(ByVal text As String) As String
            Return DMD.Sistema.Strings.Replace(text, ChrW(65535), "?")
        End Function
