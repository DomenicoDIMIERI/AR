Namespace Text
    ...
    Public Class Bidi
        ...
        Sub setReorderingMode(REORDER_INVERSE_LIKE_DIRECT As Integer)
            Throw New NotImplementedException
        End Sub

        Public Const REORDER_INVERSE_LIKE_DIRECT As Integer = 0
        Public Const RTL = 1
        Public Const LTR = 2
        Public Const DO_MIRRORING = 3

        Sub setPara(str As String, p2 As Object, p3 As Object)
            Throw New NotImplementedException
        End Sub

        Function writeReordered(DO_MIRRORING As Integer) As String
            Throw New NotImplementedException
        End Function
