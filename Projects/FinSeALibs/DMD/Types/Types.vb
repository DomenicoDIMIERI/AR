...
Namespace Internals
    ...
    Public NotInheritable Class CTypesClass
        ...
        Public Sub Initialize()
            Me.RegisteredTypeProviders.Add("CAzienda", AddressOf Anagrafica.Aziende.GetItemById)
            Me.RegisteredTypeProviders.Add("CPersonaFisica", AddressOf Anagrafica.Persone.GetItemById)
            Me.RegisteredTypeProviders.Add("CUser", AddressOf Sistema.Users.GetItemById)
            Me.RegisteredTypeProviders.Add("CGroup", AddressOf Sistema.Groups.GetItemById)
            Me.RegisteredTypeProviders.Add("CModule", AddressOf Sistema.Modules.GetItemById)
            Me.RegisteredTypeProviders.Add("CProcedura", AddressOf Sistema.Procedure.GetItemById)
        End Sub
