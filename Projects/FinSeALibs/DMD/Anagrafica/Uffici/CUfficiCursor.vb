    ...
    Public Class CUfficiCursor
        ...
        Public Overrides Function GetWherePart() As String
            ...
            If Me.m_OnlyValid Then
                wherePart = Strings.Combine(wherePart, "(([DataApertura] Is Null) Or ([DataApertura]<=" & DBUtils.DBDate(Calendar.ToDay) & "))", " AND ")
                wherePart = Strings.Combine(wherePart, "(([DataChiusura] Is Null) Or ([DataChiusura]>=" & DBUtils.DBDate(Calendar.ToDay) & "))", " AND ")
