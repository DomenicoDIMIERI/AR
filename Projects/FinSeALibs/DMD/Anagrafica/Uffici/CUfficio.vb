...
Partial Public Class Anagrafica
    ...
    Public Class CUfficio
        ...
        Private m_Utenti As CUtentiXUfficioCollection
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property DataApertura As Nullable(Of Date)
            Get
                Return Me.m_DataApertura
            End Get
            Set(value As Nullable(Of Date))
                Dim oldValue As Nullable(Of Date) = Me.m_DataApertura
                If (oldValue = value) Then Exit Property
        ...
        Public Overrides Function ToString() As String
            Return Me.m_Nome & " (" & Me.m_NomeAzienda & ")"
        End Function
        ...
        Public Function IsValid(ByVal atDate As Date) As Boolean
            Return Me.m_Attivo AndAlso Calendar.CheckBetween(atDate, Me.m_DataApertura, Me.m_DataChiusura)
        End Function
