...
Partial Public Class Anagrafica
    ...
    Public Class CManutenzione
        ...
        Public Function CompareTo(ByVal other As CManutenzione) As Integer
            Dim ret As Integer = Calendar.Compare(Me.m_DataInizioIntervento, other.m_DataInizioIntervento)
            If (ret = 0) Then ret = Calendar.Compare(Me.m_DataFineIntervento, other.m_DataFineIntervento)
