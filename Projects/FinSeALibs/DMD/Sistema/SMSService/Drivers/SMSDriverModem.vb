...
Partial Public Class Sistema
    ...
    <Flags> _
    Public Enum SMSModemFlags As Integer
        ''' <summary>
        ''' Nessun flag
        ''' </summary>
        ''' <remarks></remarks>
    ...
    ''' <summary>
    ''' Definisce una linea SMS utilizzabile da un driver
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable> _
    Public Class SMSDriverModem
        ...
        Private m_Flags As SMSModemFlags
        <NonSerialized> _
        ...
        Public Sub New()
            ...
            Me.m_UserName = ""
            Me.m_Password = ""
            Me.m_Flags = SMSModemFlags.ReceiveEnabled Or SMSModemFlags.SendEnabled
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public ReadOnly Property Owner As BasicSMSDriver
            Get
                Return Me.m_Owner
            End Get
        End Property

        Protected Friend Overridable Sub SetOwner(ByVal owner As BasicSMSDriver)
            Me.m_Owner = owner
        End Sub
        ...
        ''' <summary>
        ''' Restituisce o imposta il numero geografico utilizzato per la ricezione e l'invio di SMS
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        ''' <summary>
        ''' Restituisce o imposta l'indirizzo email a cui inviare i documenti da spedire come SMS (per i servizi SMS Out)
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        ''' <summary>
        ''' Restituisce o imposta l'indirizzo eMail di ascolto su cui vengono inviati i SMS ricevuti (per i servizi SMS in)
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Property Flags As SMSModemFlags
            Get
                Return Me.m_Flags
            End Get
            Set(value As SMSModemFlags)
                Dim oldValue As SMSModemFlags = value
                If (oldValue = value) Then Exit Property
                Me.m_Flags = value
        ...
        Public Property SendEnabled As Boolean
            Get
                Return TestFlag(Me.m_Flags, SMSModemFlags.SendEnabled)
            End Get
            Set(value As Boolean)
                If (Me.SendEnabled = value) Then Exit Property
                Me.m_Flags = SetFlag(Me.m_Flags, SMSModemFlags.SendEnabled, value)
        ...
        Public Property ReceiveEnabled As Boolean
            Get
                Return TestFlag(Me.m_Flags, SMSModemFlags.ReceiveEnabled)
            End Get
            Set(value As Boolean)
                If (Me.ReceiveEnabled = value) Then Exit Property
                Me.m_Flags = SetFlag(Me.m_Flags, SMSModemFlags.ReceiveEnabled, value)
        ...
        ''' <summary>
        ''' Restituisce la collezione dei punti operativi per cui il SMS è visibile
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        ''' <summary>
        ''' Restituisce la collezione dei gruppi a cui viene notificata la ricezione di un SMS
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        ''' <summary>
        ''' Restituisce la collezione dei gruppi a cui viene impedita la notifica di ricezione di un SMS (ha precedenza rispetto a NotificaAGruppi)
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
