...
Partial Class Sistema
    ...
    Public Class ActivePersonDateComparer
        ...
        Private Function CompareByData(ByVal x As CActivePerson, ByVal y As CActivePerson) As Integer
            Dim ret As Integer = Calendar.Compare(Calendar.GetDatePart(x.Data), Calendar.GetDatePart(y.Data))
            If (ret = 0) Then
                Dim d1 As Date = Calendar.GetDatePart(x.Data)
                Dim d2 As Date = Calendar.GetDatePart(y.Data)
                ...
                If (x.GiornataIntera) Then
                    ...
                    Else
                        ...
                        diff2 = Calendar.DateDiff(DateInterval.Minute, Calendar.Now, y.Data.Value)
                ...
                Else
                    If (y.GiornataIntera) Then
                        ...
                        diff1 = Calendar.DateDiff(DateInterval.Minute, Calendar.Now, x.Data.Value)
