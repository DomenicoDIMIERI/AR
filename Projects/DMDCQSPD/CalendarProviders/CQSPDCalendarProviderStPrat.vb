...
Partial Public Class CQSPD
    ...
    Public Class CQSPDCalendarProviderStPrat
        ...
        Private Class ItemInfo
            ...
            Public Sub New(ByVal c As CRapportino)
                ...
                Catch ex As Exception
                    Me.Anno = DateUtils.ToDay.Year
                    Me.Mese = DateUtils.ToDay.Month
                End Try
            End Sub
        ...
        Public Overrides Function GetToDoList(user As CUser) As CCollection(Of ICalendarActivity)
            ...
            Dim y As Integer = DateUtils.ToDay.Year
            Dim m As Integer = DateUtils.ToDay.Month
            ...
            For i As Integer = 0 To 11
                ...
                If (cnt > 0) Then
                    act = New CCalendarActivity
                    DirectCast(act, ICalendarActivity).SetProvider(Me)
                    act.Descrizione = "Ci sono " & cnt & " pratic" & CStr(IIf(cnt > 1, "he deliberabili", "a deliberabile")) & " il " & Formats.Format(DateUtils.MakeDate(y, m, 1), "MMMM yyyy")
                    act.DataInizio = DateUtils.Now
                    act.GiornataIntera = True
                    act.Categoria = "Urgente"
                    act.Priorita = ret.Count
