...
#End If
        ...
        Private Sub AddActivities(ByVal col As CCollection(Of StoricoAction), ByVal commissione As Commissione)
            ...
            action.Note = "Commissione Programmata. Motivo: <b>" & commissione.Motivo & "</b> presso <b>" & commissione.NomeAzienda & "</b>" & vbNewLine & "Assegnata a <b>" & commissione.NomeAssegnataA & "</b> per il <b>" & Formats.FormatUserDate(commissione.DataPrevista) & "</b>"
