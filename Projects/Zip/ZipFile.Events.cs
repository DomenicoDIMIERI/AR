...
namespace Ionic.Zip
{
    public partial class ZipFile
    {
        ...
        public event EventHandler<ExtractExceptionEventArgs> ExtractException;

        internal void OnExtractException(ExtractExceptionEventArgs e)
        {
            ExtractException.Invoke(this, e);            
        }
