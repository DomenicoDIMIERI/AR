...
public abstract class Encoding implements COSObjectable
{
     ...
     */
    protected final Map(Of NInteger, String) codeToName =
        new HashMap(Of NInteger, String)();

    /**
     * This is a mapping from a character name to a character code.
     */
    protected final Map(Of String, NInteger) nameToCode =
        new HashMap(Of String, NInteger)();
    ...
    private static void loadGlyphList(String location)
    {
        ...
        try
        {
            ...
            String line = null;
            while( (line = glyphStream.readLine()) IsNot Nothing )
            {
                line = line.trim();
     ...
     */
    public Map(Of NInteger, String) getCodeToNameMap()
    {
     ...
     */
    public Map(Of String, NInteger) getNameToCodeMap()
    {
