...
public class CCITTFaxG31DDecodeInputStream extends InputStream implements CCITTFaxConstants
{
    ...
    {
        if (Me.decodedReadPos >= Me.decodedLine.getByteCount())
        {
        ...
        byte data = Me.decodedLine.getData()[Me.decodedReadPos++];
    ...
    private boolean decodeLine() throws IOException
    {
        ...
        int expectRTC = 6;
        boolean white = true;
        while (x < Me.columns || Me.accumulatedRunLength > 0)
        {
            CodeWord code;
    ...
    private int readBit() throws IOException
    {
        ...
        final int bit = (Me.bits & BIT_POS_MASKS[Me.bitPos++]) == 0 ? 0 : 1;
