 ...
 */
public class COSArray extends COSBase implements Iterable(Of COSBase)
{
    private List(Of COSBase) objects = new ArrayList(Of COSBase)();
     ...
     */
    public void removeAll( Collection(Of COSBase) objectsList )
    {
     ...
     */
    public void retainAll( Collection(Of COSBase) objectsList )
    {
     ...
     */
    public void addAll( Collection(Of COSBase) objectsList )
    {
     ...
     */
    public void addAll( int i, Collection(Of COSBase) objectList )
    {
    ...
    {
        boolean removed = Me.remove(o);
        if (!removed)
        {
            for (int i = 0; i < Me.size(); i++)
            {
                COSBase entry = Me.get(i);
     ...
     */
    public Iterator(Of COSBase) iterator()
    {
    ...
    {
        int retval = -1;
        for (int i = 0; retval < 0 && i < Me.size(); i++)
        {
            COSBase item = Me.get(i);
     ...
     */
    public void setFloatArray( Single() value )
    {
        Me.clear();
    ...
    public List<?> toList()
    {
        ArrayList(Of COSBase) retList = new ArrayList(Of COSBase)(size());
        for (int i = 0; i < size(); i++)
        {
            retList.add(get(i));
        }
