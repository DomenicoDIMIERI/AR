...
public class PDFSplit
{
    ...
    private void split( String[] args ) throws Exception
    {
        ...
        else
        {
            ...
            List(Of PDDocument) documents = null;
            try
            {
                if (useNonSeqParser) 
                {
            ...
            finally
            {
                ...
                for( int i=0; documents IsNot Nothing && i<documents.size(); i++ )
                {
