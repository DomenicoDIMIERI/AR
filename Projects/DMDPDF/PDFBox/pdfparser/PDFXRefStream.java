...
public class PDFXRefStream implements PDFXRef
{
    ...
    public COSStream getStream() throws IOException
    {
        ...
        Set(of COSName) keySet = stream.keySet();
    ...
    {
        Set<Entry(Of COSName, COSBase)> entrySet = trailerDict.entrySet();
        for ( Entry(Of COSName, COSBase) entry : entrySet )
        {
