...
//      Get current RGB color.
        Single red = ((COSNumber)pageTokens.get( counter - 3 )).floatValue();
        Single green = ((COSNumber)pageTokens.get( counter - 2 )).floatValue();
        Single blue = ((COSNumber)pageTokens.get( counter - 1 )).floatValue();
    ...
    {
//      Get current RGB color.
        Single gray = ((COSNumber)pageTokens.get( counter - 1 )).floatValue();
    ...
    private static Single() convertRGBToCMYK( Single red, Single green, Single blue )
    {
        //
        // RGB->CMYK from From
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        if( outputFile Is Nothing || outputFile.equals(inputFile))
        {
            usage();
        }
    ...
    private static class ColorSpaceInstance
    {
        ...
        public boolean equals( Object o )
        {
            ...
            if( o instanceof ColorSpaceInstance )
            {
                ...
                if( Me.colorspace.equals( other.colorspace ) &&
