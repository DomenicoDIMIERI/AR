...
{
    private List(Of String) regions = new ArrayList(Of String)();
    private Map(Of String,RectangleF) regionArea = new HashMap(Of String,RectangleF)();
    private Map(Of String,Vector(Of ArrayList(Of TextPosition))) regionCharacterList = 
        new HashMap(Of String,Vector(Of ArrayList(Of TextPosition)))();
    private Map(Of String,StringWriter) regionText = new HashMap(Of String,StringWriter)();
   ...
   /**
     ...
     */
    public List(Of String) getRegions()
    {
        return regions;
    }
    ...
    {
        Iterator(Of String) regionIter = regions.iterator();
        while( regionIter.hasNext() )
        {
            ...
            Vector(Of ArrayList(Of TextPosition)) regionCharactersByArticle = new Vector(Of ArrayList(Of TextPosition))();
    ...
    {
        Iterator(Of String) regionIter = regionArea.keySet().iterator();
        while( regionIter.hasNext() )
        {
