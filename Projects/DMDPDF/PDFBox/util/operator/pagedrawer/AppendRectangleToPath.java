...
public class AppendRectangleToPath extends OperatorProcessor
{
    ...
    public void process(PDFOperator operator, List(Of COSBase) arguments)
    {
        ...
        Single width = (Single)(endCoords.getX()-startCoords.getX());
        Single height = (Single)(endCoords.getY()-startCoords.getY());
        Single xStart = (Single)startCoords.getX();
        Single yStart = (Single)startCoords.getY();
