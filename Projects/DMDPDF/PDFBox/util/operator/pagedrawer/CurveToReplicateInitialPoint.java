...
public class CurveToReplicateInitialPoint extends OperatorProcessor
{
    ...
    public void process(PDFOperator operator, List(Of COSBase) arguments)
    {
        ...
        drawer.getLinePath().curveTo((Single)currentPoint.getX(), (Single)currentPoint.getY(),
                (Single)point2.getX(), (Single)point2.getY(), (Single)point3.getX(), (Single)point3.getY());
    }
}
