...
public class ExtractImages
{
    ...
    private void extractImages( String[] args ) throws Exception
    {
        ...
        else
        {
            ...
            {
                if( prefix Is Nothing && pdfFile.length() >4 )
                {
    ...
    private void processResources(PDResources resources, String prefix, boolean addKey) throws IOException
    {
        ...
        Map(Of String, PDXObject) xobjects = resources.getXObjects();
        if( xobjects IsNot Nothing )
        {
            Iterator(Of String) xobjectIter = xobjects.keySet().iterator();
