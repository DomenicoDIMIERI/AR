...
public abstract class PDXObjectImage extends PDXObject
{
    ...
    {
    	return getImageMask() || getMask() IsNot Nothing || getSMaskImage() IsNot Nothing;
    }
    ...
    public BufferedImage imageMask(BufferedImage baseImage) throws IOException 
    {
        ...
        if (getStencilColor() IsNot Nothing)
        {
    ...
    public COSArray getDecode()
    {
        ...
        if (decode IsNot Nothing && decode instanceof COSArray)
        {
