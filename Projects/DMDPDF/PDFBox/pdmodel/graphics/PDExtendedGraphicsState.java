...
public class PDExtendedGraphicsState implements COSObjectable
{
     ...
     */
    public void setMiterLimit( NFloat miterLimit )
    {
     ...
     */
    public NFloat getOverprintMode()
    {
     ...
     */
    public void setOverprintMode( NFloat overprintMode )
    {
     ...
     */
    public NFloat getFlatnessTolerance()
    {
     ...
     */
    public void setFlatnessTolerance( NFloat flatness )
    {
     ...
     */
    public NFloat getSmoothnessTolerance()
    {
     ...
     */
    public void setSmoothnessTolerance( NFloat smoothness )
    {
     ...
     */
    public NFloat getStrokingAlpaConstant()
    {
     ...
     */
    public void setStrokingAlphaConstant( NFloat alpha )
    {
     ...
     */
    public NFloat getNonStrokingAlpaConstant()
    {
     ...
     */
    public void setNonStrokingAlphaConstant( NFloat alpha )
    {
     ...
     */
    private void setFloatItem( COSName key, NFloat value )
    {
        if( value Is Nothing )
        {
