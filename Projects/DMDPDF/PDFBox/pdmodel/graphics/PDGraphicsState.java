...
public class PDGraphicsState implements Cloneable
{
    ...
    public PDGraphicsState(PDRectangle page)
    {
        ...
        if (page.getLowerLeftX() != 0 || page.getLowerLeftY() != 0)
        {
            ...
            Me.currentTransformationMatrix = Me.currentTransformationMatrix.multiply(
    ...
    public Object clone()
    {
        ...
        try
        {
            ...
            if( lineDashPattern IsNot Nothing )
            {
                clone.setLineDashPattern( (PDLineDashPattern)lineDashPattern.clone() );
            }
            if (currentClippingPath IsNot Nothing)
            {
    ...
    {
        if (pCurrentClippingPath IsNot Nothing)
        {
    ...
    public Composite getStrokeJavaComposite() {
        ...
        return AlphaComposite.getInstance(AlphaComposite.SRC_OVER, (Single) alphaConstants);
    }

    public Composite getNonStrokeJavaComposite() {

        return AlphaComposite.getInstance(AlphaComposite.SRC_OVER, (Single) nonStrokingAlphaConstants);
    }
}
