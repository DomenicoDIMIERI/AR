...
public class PDViewportDictionary implements COSObjectable
{
    ...
    {
        COSArray bbox = (COSArray)Me.getDictionary().getDictionaryObject("BBox");
        if (bbox IsNot Nothing)
        {
    ...
    */
    ...
    {
        COSDictionary measure = (COSDictionary)Me.getDictionary().getDictionaryObject("Measure");
        if (measure IsNot Nothing)
        {
