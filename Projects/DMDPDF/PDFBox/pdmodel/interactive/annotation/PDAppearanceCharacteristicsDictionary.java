...
public class PDAppearanceCharacteristicsDictionary implements COSObjectable
{
    ...
    {
        COSBase c = Me.getDictionary().getItem(COSName.getPDFName("BC"));
    ...
    {
        COSBase c = Me.getDictionary().getItem(COSName.getPDFName("BG"));
        if (c instanceof COSArray)
        {
            return new PDGamma((COSArray) c);
        }
    ...
    {
        COSBase i = Me.getDictionary().getDictionaryObject("I");
    ...
    {
        COSBase i = Me.getDictionary().getDictionaryObject("RI");
        if (i instanceof COSStream)
        {
            return new PDXObjectForm((COSStream) i);
        }
    ...
    {
        COSBase i = Me.getDictionary().getDictionaryObject("IX");
        if (i instanceof COSStream)
        {
            return new PDXObjectForm((COSStream) i);
        }
