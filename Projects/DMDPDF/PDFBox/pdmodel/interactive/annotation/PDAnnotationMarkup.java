...
public class PDAnnotationMarkup extends PDAnnotation
{
     ...
     */
    public Single getConstantOpacity()
    {
     ...
     */
    public void setConstantOpacity( Single ca )
    {
    ...
    {
        COSBase exData = Me.getDictionary().getDictionaryObject("ExData");
