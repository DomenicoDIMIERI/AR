...
public class PDSeedValue implements COSObjectable
{
    ...
    */
     ...
     */
    public List(Of String) getSubFilter()
    {
        ...
        {
            List(Of String) actuals = new ArrayList(Of String)();
     ...
     */
    public void setSubFilter(List(of COSName) subfilter)
    {
     ...
     */
    public List(Of String) getDigestMethod()
    {
        List(Of String) retval = null;
     ...
     * used for signing.
     */
    public void setDigestMethod(List(of COSName) digestMethod)
    {
        // integrity check
     ...
     */
    public void setV(Single minimumRequiredCapability)
    {
     ...
     */
    public List(Of String) getReasons()
    {
        List(Of String) retval = null;
     ...
     */
    public void setReasonsd(List(Of String) reasons)
    {
     ...
     * @return the reasons that should be used by the signature handler
     */
    public List(Of String) getLegalAttestation()
    {
        List(Of String) retval = null;
     ...
     * legal attestations.
     */
    public void setLegalAttestation(List(Of String) legalAttestation)
    {
