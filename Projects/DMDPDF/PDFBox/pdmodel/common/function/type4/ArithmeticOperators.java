...
class ArithmeticOperators
{
    ...
    static class Add implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            if (num1 instanceof Integer && num2 instanceof Integer)
            {
                ...
                {
                    context.getStack().push(NFloat.valueOf(sum));
                }
                else
                {
            ...
            {
                Single sum = num1.floatValue() + num2.floatValue();
                context.getStack().push(NFloat.valueOf(sum));
            }
        }
    ...
    static class Atan implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            Single den = context.popReal();
            Single num = context.popReal();
            Single atan = (Single)Math.atan2(num, den);
            atan = (Single)Math.toDegrees(atan) % 360;
            if (atan < 0)
            {
                atan = atan + 360;
            }
    ...
    static class Ceiling implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            {
                context.getStack().push((Single)Math.ceil(num.doubleValue()));
            }
        }
    ...
    static class Cos implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            Single angle = context.popReal();
            Single cos = (Single)Math.cos(Math.toRadians(angle));
    ...
    static class Exp implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            context.getStack().push((Single)value);
        }
    ...
    static class Floor implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            {
                context.getStack().push((Single)Math.floor(num.doubleValue()));
            }
        }
    ...
    static class Ln implements Operator
    {
        ...
        {
            Number num = context.popNumber();
            context.getStack().push((Single)Math.log(num.doubleValue()));
        }
    ...
    static class Log implements Operator
    {
        ...
        {
            Number num = context.popNumber();
            context.getStack().push((Single)Math.log10(num.doubleValue()));
        }
    ...
    static class Mul implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            if (num1 instanceof Integer && num2 instanceof Integer)
            {
                ...
                {
                    context.getStack().push((Single)result);
                }
            }
            else
            {
    ...
    static class Round implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            {
                context.getStack().push((Single)Math.round(num.doubleValue()));
            }
        }
    ...
    static class Sin implements Operator
    {
        ...
        {
            Single angle = context.popReal();
            Single sin = (Single)Math.sin(Math.toRadians(angle));
    ...
    static class Sqrt implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            context.getStack().push((Single)Math.sqrt(num));
        }
    ...
    static class Sub implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            if (num1 instanceof Integer && num2 instanceof Integer)
            {
                ...
                if (result < Integer.MIN_VALUE || result > Integer.MAX_VALUE)
                {
                    stack.push(NFloat.valueOf(result));
                }
                else
                {
            ...
            {
                Single result = num1.floatValue() - num2.floatValue();
                stack.push(NFloat.valueOf(result));
            }
        }
    ...
    static class Truncate implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            {
                context.getStack().push((Single)(int)(num.floatValue()));
            }
        }
