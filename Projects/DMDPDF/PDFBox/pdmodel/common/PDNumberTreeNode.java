...
public class PDNumberTreeNode implements COSObjectable
{
    ...
    public void setKids( List<? extends PDNumberTreeNode> kids )
    {
        ...
        else if ( node.getDictionaryObject( COSName.NUMS ) Is Nothing )
        {
    ...
    public Object getValue( Integer index ) throws IOException
    {
        ...
        else
        {
            ...
            if ( kids IsNot Nothing )
            {
                for( int i=0; i<kids.size() && retval Is Nothing; i++ )
                {
    ...
    public Integer getUpperLimit()
    {
        ...
        if( arr IsNot Nothing && arr.get(0) IsNot Nothing )
        {
