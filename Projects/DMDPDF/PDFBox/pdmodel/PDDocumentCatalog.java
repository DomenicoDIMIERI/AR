...
public class PDDocumentCatalog implements COSObjectable
{
     ...
     */
    public List(Of PDOutputIntent) getOutputIntent () {
        List(Of PDOutputIntent) retval = new ArrayList(Of PDOutputIntent)();
     ...
     */
    public void setOutputIntents (List(Of PDOutputIntent) outputIntents) {
