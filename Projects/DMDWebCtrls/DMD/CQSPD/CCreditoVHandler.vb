    ...
    Public Class CCreditoVHandler
        ...
        Public Function GetStatoLavorazione(ByVal renderer As Object) As String
            ...
            Try
                ...
                di = DateUtils.DateAdd(DateInterval.Year, -1, DateUtils.ToDay)
                df = DateUtils.DateAdd(DateInterval.Day, CQSPD.Configuration.GiorniAnticipoRifin, DateUtils.ToDay)
                ' If (df.HasValue = False) Then df = DateUtils.GetLastMonthDay(DateUtils.ToDay)
                ' If (di.HasValue = False) Then di = DateUtils.GetPrevMonthFirstDay(DateUtils.ToDay)
        ...
        Public Function GetFinanziamentiRinnovabili(ByVal renderer As Object) As String
            ...
            Try
                ...
                cursor.DataPrevista.Between(DateUtils.DateAdd(DateInterval.Day, 30, Now), DateUtils.DateAdd(DateInterval.Day, -30, Now))
                ...
                'Dim interval As CIntervalloData = DateUtils.PeriodoToDates(periodo, di, df)
                'di = interval.Inizio
                'df = interval.Fine
                'If (di.HasValue AndAlso df.HasValue AndAlso di.Value = df.Value) Then df = DateUtils.DateAdd(DateInterval.Second, 24 * 3600 - 1, di.Value)
        ...
        Public Function GetRichiestaPendenti(ByVal renderer As Object) As String
            ...
            di = interval.Inizio
            df = interval.Fine
            If (df.HasValue) Then df = DateUtils.DateAdd(DateInterval.Second, 24 * 3600 - 1, DateUtils.GetDatePart(df.Value))
        ...
        Public Function GetStatisticheLiquidato(ByVal renderer As Object) As String
            ...
            For i As Integer = 1 To 12
                chart.Labels.Add(DateUtils.GetShortMonthName(i))
            Next
