...
Namespace Forms
    ...
    Public Class CModuleRapportiniHandler
        ...
        Public Function Sollecita(ByVal renderer As Object) As String
            ...
            Dim pratica As CRapportino = DMD.CQSPD.Pratiche.GetItemById(pid)
            pratica.Sollecita()
            Return XML.Utils.Serializer.Serialize(pratica.RichiestaApprovazione)
        End Function
        ...
        '            d = DateUtils.GetDatePart(DateAdd("m", Fix(percComplet * Formats.ToInteger(pratica.NumeroRate) / 100), d))
