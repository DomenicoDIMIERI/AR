...
Namespace Forms
    ...
    Public Class CQSPDCAPStatsHandler
        ...
        Public Function GetStats(ByVal renderer As Object) As String
            ...
            Try
                If Not Me.Module.UserCanDoAction("list") Then Throw New PermissionDeniedException("list")
                ...
                Dim dbSQL As String = "SELECT [ResidenteACAP], [IDStatoAttuale], Count(*) As [Conteggio], Sum([MontanteLordo]) As [Montante] FROM (" & cursor.GetSQL & ") GROUP By [ResidenteACAP], [IDStatoAttuale] "
                ...
                While dbRis.Read
                    Dim key As String = Formats.ToString(dbRis("ResidenteACAP"))
