...
Namespace Forms
    ...
    Public Class CSystemModuleHandler
        ...
        Public Function getScadenze(ByVal renderer As Object) As String
            ...
            items = DateUtils.GetScadenze(f, t)
        ...
        '    DateUtils.Providers.RegisterProvider(pName, className)
        '    Return vbNullString
        'End Function
        ...
        '    Dim pName As String
        '    pName = RPC.n2str(Me.GetParameter(renderer, "pName"))
        '    DateUtils.Providers.UnregisterProvider(pName)
        '    Return vbNullString
        'End Function
