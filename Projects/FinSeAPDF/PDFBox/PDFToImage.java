...
public class PDFToImage
{
    ...
    */
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        String color = "rgb";
        int resolution;
        Single cropBoxLowerLeftX = 0;
        Single cropBoxLowerLeftY = 0;
        Single cropBoxUpperRightX = 0;
        Single cropBoxUpperRightY = 0;
        try
        {
        ...
        for( int i = 0; i < args.length; i++ )
        {
            ...
            {
                i++;
                cropBoxLowerLeftX = NFloat.valueOf(args(i)).floatValue();
                i++;
                cropBoxLowerLeftY = NFloat.valueOf(args(i)).floatValue();
                i++;
                cropBoxUpperRightX = NFloat.valueOf(args(i)).floatValue();
                i++;
                cropBoxUpperRightY = NFloat.valueOf(args(i)).floatValue();
            }
        ...
        else
        {
            ...
            try
            {
                ...
                //changeCropBoxes(PDDocument document,Single a, Single b, Single c,Single d)
    ...
    private static void usage()
    {
        System.err.println( "Usage: java -jar pdfbox-app-x.y.z.jar PDFToImage [OPTIONS] <PDF file>\n" +
            ...
            "  -color (Of String)                The color depth (valid: bilevel, indexed, gray, rgb, rgba)\n" +
    ...
    private static void changeCropBoxes(PDDocument document,Single a, Single b, Single c,Single d)
    {
