...
Namespace org.apache.pdfbox.encoding.conversion
    ...
    Class CJKEncodings
        ...
        Private Shared charsetMapping As New HashMap()
        ...
        '  */
        Public Shared Function getCharset(ByVal encoding As String) As String
            If (encoding.startsWith("COSName")) Then
                encoding = encoding.Substring(8, encoding.Length() - 1)
            End If
            Return charsetMapping.get(encoding)
        End Function

        '/**
        ' *  Return an iterator to iterate through all encodings.
        ' */
        Public Shared Function getEncodingIterator() As Global.System.Collections.IEnumerator
            Return charsetMapping.keySet().GetEnumerator
        End Function
