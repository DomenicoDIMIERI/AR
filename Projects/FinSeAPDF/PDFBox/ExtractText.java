    ...
    */
    ...
    public void startExtraction( String[] args ) throws Exception
    {
        ...
        else
        {
            ...
            try
            {
                ...
                if( outputFile Is Nothing && pdfFile.length() >4 )
                {
                ...
                if (names IsNot Nothing)
                {
                    ...
                    if (embeddedFiles IsNot Nothing)
                    {
                        Map<String,COSObjectable> embeddedFileNames = embeddedFiles.getNames();
                        if (embeddedFileNames IsNot Nothing) {
    ...
    private void stopProcessing(String message, long startTime) 
    {
        if (debug)
        {
            ...
            Single elapsedTime = ((Single)(stopTime - startTime))/1000;
