...
{
    private List(Of Object) streamObjects = new ArrayList(Of Object)( 100 );
    ...
    public void parse() throws IOException
    {
        ...
        {
            Object token = null;
            while( (token = parseNextToken()) IsNot Nothing )
            {
     ...
     */
    public List(Of Object) getTokens()
    {
     ...
     */
    public Iterator(Of Object) getTokenIterator()
    {
        return new Iterator(Of Object)()
        {
