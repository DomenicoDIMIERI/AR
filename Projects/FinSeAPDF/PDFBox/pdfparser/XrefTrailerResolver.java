...
public class XrefTrailerResolver
{
    ...
    {
        if ( curXrefTrailerObj Is Nothing )
        {
            // should not happen...
    ...
    {
        if ( resolvedXrefTrailer IsNot Nothing )
        {
        ...
        else
        {
            ...
            while ( curObj.trailer IsNot Nothing )
            {
        ...
        for ( Long bPos : xrefSeqBytePos )
        {
            ...
            if ( curObj.trailer IsNot Nothing )
            {
    ...
    {
        return ( resolvedXrefTrailer Is Nothing ) ? null : resolvedXrefTrailer.trailer;
    }
    ...
    {
        return ( resolvedXrefTrailer Is Nothing ) ? null : resolvedXrefTrailer.xrefTable;
    }
    ...
    {
        if ( resolvedXrefTrailer Is Nothing )
        {
            return null;
        }
