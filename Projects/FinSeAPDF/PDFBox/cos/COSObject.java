...
public class COSObject extends COSBase
{
    ...
    {
        return "COSObject{" +
            (objectNumber Is Nothing ? "unknown" : "" + objectNumber.intValue() ) + ", " +
            (generationNumber Is Nothing ? "unknown" : "" + generationNumber.intValue() ) +
            "}";
    }
    ...
    {
        return getObject() IsNot Nothing ? getObject().accept( visitor ) : COSNull.NULL.accept( visitor );
    }
}
