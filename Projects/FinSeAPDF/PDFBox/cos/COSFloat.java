...
public class COSFloat extends COSNumber
{
     ...
     */
    public void setValue( Single floatValue )
    {
    ...
    {
        return o instanceof COSFloat && NFloat.floatToIntBits(((COSFloat)o).value.floatValue()) == NFloat.floatToIntBits(value.floatValue());
    }
