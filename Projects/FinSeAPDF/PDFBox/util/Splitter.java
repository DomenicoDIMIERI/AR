...
public class Splitter
{
    ...
    private List(Of PDDocument) newDocuments = null;
     ...
     */
    public List(Of PDDocument) split( PDDocument document ) throws IOException
    {
    ...
    {
        return pageNumber % splitAtPage == 0 || currentDocument Is Nothing;
    }
