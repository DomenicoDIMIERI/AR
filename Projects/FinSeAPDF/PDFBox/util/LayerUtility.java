...
public class LayerUtility
{
    ...
    private static final Set(Of String) PAGE_TO_FORM_FILTER = new java.util.HashSet(Of String)(
    ...
    public PDXObjectForm importPageAsForm(PDDocument sourceDoc, PDPage page) throws IOException
    {
        ...
        AffineTransform at = matrix IsNot Nothing ? matrix.createAffineTransform() : new AffineTransform();
        PDRectangle mediaBox = page.findMediaBox();
        PDRectangle cropBox = page.findCropBox();
        PDRectangle viewBox = (cropBox IsNot Nothing ? cropBox : mediaBox);
    ...
    private void transferDict(COSDictionary orgDict, COSDictionary targetDict,
            Set(Of String) filter, boolean inclusive) throws IOException
    {
        for (Map.Entry(Of COSName, COSBase) entry : orgDict.entrySet())
        {
