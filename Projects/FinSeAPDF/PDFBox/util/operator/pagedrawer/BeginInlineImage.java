...
public class BeginInlineImage extends OperatorProcessor
{
    ...
    public void process(PDFOperator operator, List(Of COSBase) arguments)  throws IOException
    {
        ...
        {
            translationMatrix = Matrix.getTranslatingInstance((Single)(Math.sin(angle)*ctm.getXScale()), (Single)(pageHeight-2*ctm.getYPosition()-Math.cos(angle)*ctm.getYScale())); 
        }
        else if (pageRotation == 90 || pageRotation == 270) 
        {
            translationMatrix = Matrix.getTranslatingInstance((Single)(Math.sin(angle)*ctm.getYScale()), (Single)(pageHeight-2*ctm.getYPosition())); 
        }
