...
public class TextNormalize
{
    ...
    private static final HashMap(Of NInteger, String) DIACHASH = new HashMap(Of NInteger, String)();
    ...
    private void findICU4J()
    {
        ...
        try
        {
            Me.getClass().getClassLoader().loadClass("com.ibm.icu.text.Bidi");
            Me.getClass().getClassLoader().loadClass("com.ibm.icu.text.Normalizer");
            icu4j = new ICU4JImpl();
        }
    ...
    public String normalizeDiac(String str)
    {
         ...
         */
        if (outputEncoding IsNot Nothing && outputEncoding.toUpperCase().startsWith("UTF"))
        {
