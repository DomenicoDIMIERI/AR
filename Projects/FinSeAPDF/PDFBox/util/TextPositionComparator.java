...
public class TextPositionComparator implements Comparator
{
    ...
    public int compare(Object o1, Object o2)
    {
        ...
        Single x1 = pos1.getXDirAdj();
        Single x2 = pos2.getXDirAdj();
        
        Single pos1YBottom = pos1.getYDirAdj();
        Single pos2YBottom = pos2.getYDirAdj();
        // note that the coordinates have been adjusted so 0,0 is in upper left
        Single pos1YTop = pos1YBottom - pos1.getHeightDir();
        Single pos2YTop = pos2YBottom - pos2.getHeightDir();

        Single yDifference = Math.abs( pos1YBottom-pos2YBottom);
