...
public class PackedBitArray
{
    ...
    public void set(int offset)
    {
        ...
        Me.data[byteOffset] |= 1 << bitOffset(offset);
    }
    ...
    public void clear(int offset)
    {
        ...
        Me.data[byteOffset] &= ~(1 << bitOffset);
    }
    ...
    public void setBits(int offset, int length)
    {
        ...
        if (firstByte == lastByte)
        {
            ...
            Me.data[firstByte] |= mask;
        }
        else
        {
            //Bits spanning multiple bytes
            Me.data[firstByte] |= 0xFF << startBitOffset;
            ...
            if (endBitOffset > 0)
            {
                Me.data[lastByte] |= 0xFF >> (8 - endBitOffset);
            }
        }
    }
