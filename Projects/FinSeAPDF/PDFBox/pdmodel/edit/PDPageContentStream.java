...
public class PDPageContentStream
{
    ...
    private Single() colorComponents = new Single(4);
            ...
            boolean resetContext) throws IOException
    {
        ...
        boolean hasContent = contents IsNot Nothing;
        ...
        if (appendContent && hasContent)
        {
            ...
            if (compress)
            {
                List(of COSName) filters = new ArrayList(of COSName)();
     ...
     */
    public void setFont(PDFont font, Single fontSize) throws IOException
    {
     ...
     */
    public void drawImage(PDXObjectImage image, Single x, Single y) throws IOException
    {
     ...
     * @throws IOException If there is an error writing to the stream.
     */
    public void drawXObject(PDXObject xobject, Single x, Single y, Single width, Single height) throws IOException
    {
     ...
     * @throws IOException If there is an error writing to the stream.
     */
    public void moveTextPositionByAmount(Single x, Single y) throws IOException
    {
        if (!inTextMode)
        {
    ...
    */
     ...
     */
    public void setStrokingColor(Single() components) throws IOException
    {
    ...
    public void setStrokingColor(Color color) throws IOException
    {
        ...
        {
            color.getColorComponents(colorComponents);
            setStrokingColor(colorComponents(0), colorComponents(1), colorComponents(2), colorComponents(2));
        }
        else
        {
    ...
    public void setNonStrokingColor(Color color) throws IOException
    {
        ...
        {
            color.getColorComponents(colorComponents);
            setNonStrokingColor(colorComponents(0), colorComponents(1), colorComponents(2), colorComponents(2));
        }
        else
        {
            throw new IOException("Error: unknown colorspace:" + colorSpace);
     ...
     * @throws IOException If there is an error while writing to the stream.
     */
    public void setNonStrokingColor(Single() components) throws IOException
    {
        for (int i = 0; i < components.length; i++)
        {
            appendRawCommands(components(i));
     ...
     */
    public void addRect(Single x, Single y, Single width, Single height) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while drawing on the screen.
     */
    public void fillRect(Single x, Single y, Single width, Single height) throws IOException
    {
        if (inTextMode)
        {
     ...
     */
    public void addBezier312(Single x1, Single y1, Single x2, Single y2, Single x3, Single y3) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while adding the .
     */
    public void addBezier32(Single x2, Single y2, Single x3, Single y3) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while adding the .
     */
    public void addBezier31(Single x1, Single y1, Single x3, Single y3) throws IOException
    {
        if (inTextMode)
        {
     ...
     */
    public void moveTo(Single x, Single y) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while adding the line.
     */
    public void lineTo(Single x, Single y) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while adding the line.
     */
    public void addLine(Single xStart, Single yStart, Single xEnd, Single yEnd) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while drawing on the screen.
     */
    public void drawLine(Single xStart, Single yStart, Single xEnd, Single yEnd) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while drawing on the screen.
     */
    public void addPolygon(Single() x, Single() y) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while drawing on the screen.
     */
    public void drawPolygon(Single() x, Single() y) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while drawing on the screen.
     */
    public void fillPolygon(Single() x, Single() y) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while drawing on the screen.
     */
    public void setLineWidth(Single lineWidth) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If there is an error while writing to the stream.
     */
    public void setLineDashPattern(Single() pattern, Single phase) throws IOException
    {
        if (inTextMode)
        {
     ...
     * @throws IOException If an error occurs while writing to the stream.
     */
    public void appendRawCommands(Single data) throws IOException
    {
        appendRawCommands(formatDecimal.format(data));
    }
