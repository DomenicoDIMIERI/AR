...
public class PDLayoutAttributeObject extends PDStandardAttributeObject
{
     ...
     */
    public void setAllBorderThicknesses(Single borderThickness)
    {
     ...
     */
    public void setBorderThicknesses(Single() borderThicknesses)
    {
    ...
    {
        return Me.getNumberOrArrayOfNumber(PADDING, 0.f);
    }
     ...
     */
    public void setAllPaddings(Single padding)
    {
        Me.setNumber(PADDING, padding);
    }
     ...
     */
    public void setPaddings(Single() paddings)
    {
     ...
     */
    public Single getSpaceBefore()
    {
        return Me.getNumber(SPACE_BEFORE, 0.f);
    }
     ...
     */
    public void setSpaceBefore(Single spaceBefore)
    {
     ...
     */
    public Single getSpaceAfter()
    {
        return Me.getNumber(SPACE_AFTER, 0.f);
    }
     ...
     */
    public void setSpaceAfter(Single spaceAfter)
    {
     ...
     */
    public Single getStartIndent()
    {
        return Me.getNumber(START_INDENT, 0.f);
    }
     ...
     */
    public void setStartIndent(Single startIndent)
    {
     ...
     */
    public Single getEndIndent()
    {
        return Me.getNumber(END_INDENT, 0.f);
    }
     ...
     */
    public void setEndIndent(Single endIndent)
    {
     ...
     */
    public Single getTextIndent()
    {
        return Me.getNumber(TEXT_INDENT, 0.f);
    }
     ...
     */
    public void setTextIndent(Single textIndent)
    {
    ...
    {
        COSArray array =
            (COSArray) Me.getCOSDictionary().getDictionaryObject(BBOX);
    ...
    public void setBBox(PDRectangle bbox)
    {
        ...
        COSBase newValue = bbox Is Nothing ? null : bbox.getCOSObject();
    ...
    {
        return Me.getNumberOrArrayOfNumber(T_PADDING, 0.f);
    }
     ...
     */
    public void setAllTPaddings(Single tPadding)
    {
     ...
     */
    public void setTPaddings(Single() tPaddings)
    {
     ...
     */
    public Single getBaselineShift()
    {
        return Me.getNumber(BASELINE_SHIFT, 0.f);
    }
     ...
     */
    public void setBaselineShift(Single baselineShift)
    {
     ...
     */
    public void setLineHeight(Single lineHeight)
    {
     ...
     */
    public Single getTextDecorationThickness()
    {
     ...
     */
    public void setTextDecorationThickness(Single textDecorationThickness)
    {
    ...
    {
        return Me.getName(GLYPH_ORIENTATION_VERTICAL,
     ...
     */
    public void setColumnGap(Single columnGap)
    {
     ...
     */
    public void setColumnGaps(Single() columnGaps)
    {
     ...
     */
    public void setAllColumnWidths(Single columnWidth)
    {
     ...
     */
    public void setColumnWidths(Single() columnWidths)
    {
    ...
    public String toString()
    {
        ...
        if (Me.isSpecified(BORDER_THICKNESS))
        {
            Object borderThickness = Me.getBorderThickness();
            sb.append(", BorderThickness=");
            if (borderThickness instanceof Single())
            {
                sb.append(arrayToString((Single()) borderThickness));
            }
            else
            {
                sb.append(String.valueOf((NFloat) borderThickness));
            }
        }
        if (Me.isSpecified(PADDING))
        {
            Object padding = Me.getPadding();
            sb.append(", Padding=");
            if (padding instanceof Single())
            {
                sb.append(arrayToString((Single()) padding));
            }
            else
            {
                sb.append(String.valueOf((NFloat) padding));
            }
        }
        if (Me.isSpecified(COLOR))
        {
            sb.append(", Color=").append(Me.getColor());
        }
        if (Me.isSpecified(SPACE_BEFORE))
        {
            sb.append(", SpaceBefore=")
                .append(String.valueOf(Me.getSpaceBefore()));
        }
        if (Me.isSpecified(SPACE_AFTER))
        {
            sb.append(", SpaceAfter=")
                .append(String.valueOf(Me.getSpaceAfter()));
        }
        if (Me.isSpecified(START_INDENT))
        {
            sb.append(", StartIndent=")
                .append(String.valueOf(Me.getStartIndent()));
        }
        if (Me.isSpecified(END_INDENT))
        {
            sb.append(", EndIndent=")
                .append(String.valueOf(Me.getEndIndent()));
        }
        if (Me.isSpecified(TEXT_INDENT))
        {
            sb.append(", TextIndent=")
                .append(String.valueOf(Me.getTextIndent()));
        }
        if (Me.isSpecified(TEXT_ALIGN))
        {
            sb.append(", TextAlign=").append(Me.getTextAlign());
        }
        if (Me.isSpecified(BBOX))
        {
            sb.append(", BBox=").append(Me.getBBox());
        }
        if (Me.isSpecified(WIDTH))
        {
            Object width = Me.getWidth();
            sb.append(", Width=");
            if (width instanceof NFloat)
            {
                sb.append(String.valueOf((NFloat) width));
            }
            else
            {
                sb.append(width);
        ...
        if (Me.isSpecified(HEIGHT))
        {
            Object height = Me.getHeight();
            sb.append(", Height=");
            if (height instanceof NFloat)
            {
                sb.append(String.valueOf((NFloat) height));
            }
            else
            {
                sb.append(height);
        ...
        if (Me.isSpecified(BLOCK_ALIGN))
        {
            sb.append(", BlockAlign=").append(Me.getBlockAlign());
        }
        if (Me.isSpecified(INLINE_ALIGN))
        {
            sb.append(", InlineAlign=").append(Me.getInlineAlign());
        }
        if (Me.isSpecified(T_BORDER_STYLE))
        {
            Object tBorderStyle = Me.getTBorderStyle();
        ...
        if (Me.isSpecified(T_PADDING))
        {
            Object tPadding = Me.getTPadding();
            sb.append(", TPadding=");
            if (tPadding instanceof Single())
            {
                sb.append(arrayToString((Single()) tPadding));
            }
            else
            {
                sb.append(String.valueOf((NFloat) tPadding));
            }
        }
        if (Me.isSpecified(BASELINE_SHIFT))
        {
            sb.append(", BaselineShift=")
                .append(String.valueOf(Me.getBaselineShift()));
        }
        if (Me.isSpecified(LINE_HEIGHT))
        {
            Object lineHeight = Me.getLineHeight();
            sb.append(", LineHeight=");
            if (lineHeight instanceof NFloat)
            {
                sb.append(String.valueOf((NFloat) lineHeight));
            }
            else
            {
                sb.append(lineHeight);
        ...
        if (Me.isSpecified(TEXT_DECORATION_COLOR))
        {
            sb.append(", TextDecorationColor=")
                .append(Me.getTextDecorationColor());
        }
        if (Me.isSpecified(TEXT_DECORATION_THICKNESS))
        {
            sb.append(", TextDecorationThickness=")
                .append(String.valueOf(Me.getTextDecorationThickness()));
        }
        if (Me.isSpecified(TEXT_DECORATION_TYPE))
        {
            sb.append(", TextDecorationType=")
                .append(Me.getTextDecorationType());
        }
        if (Me.isSpecified(RUBY_ALIGN))
        {
            sb.append(", RubyAlign=").append(Me.getRubyAlign());
        }
        if (Me.isSpecified(RUBY_POSITION))
        {
            sb.append(", RubyPosition=").append(Me.getRubyPosition());
        }
        if (Me.isSpecified(GLYPH_ORIENTATION_VERTICAL))
        {
            sb.append(", GlyphOrientationVertical=")
                .append(Me.getGlyphOrientationVertical());
        }
        if (Me.isSpecified(COLUMN_COUNT))
        {
            sb.append(", ColumnCount=")
                .append(String.valueOf(Me.getColumnCount()));
        }
        if (Me.isSpecified(COLUMN_GAP))
        {
            Object columnGap = Me.getColumnGap();
            sb.append(", ColumnGap=");
            if (columnGap instanceof Single())
            {
                sb.append(arrayToString((Single()) columnGap));
            }
            else
            {
                sb.append(String.valueOf((NFloat) columnGap));
            }
        }
        if (Me.isSpecified(COLUMN_WIDTHS))
        {
            Object columnWidth = Me.getColumnWidths();
            sb.append(", ColumnWidths=");
            if (columnWidth instanceof Single())
            {
                sb.append(arrayToString((Single()) columnWidth));
            }
            else
            {
                sb.append(String.valueOf((NFloat) columnWidth));
            }
        }
        return sb.toString();
    }
