...
class StackOperators
{
    ...
    static class Copy implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            if (n > 0)
            {
                ...
                List(Of Object) copy = new java.util.ArrayList(Of Object)(
    ...
    static class Roll implements Operator
    {
        ...
        public void execute(ExecutionContext context)
        {
            ...
            LinkedList(Of Object) rolled = new LinkedList(Of Object)();
            LinkedList(Of Object) moved = new LinkedList(Of Object)();
            if (j < 0)
            {
                //negative roll
                int n1 = n + j;
