...
public class PDStream implements COSObjectable
{
    ...
    {
        List(of COSName) filters = getFilters();
     ...
     */
    public InputStream getPartiallyFilteredStream(List(Of String) stopFilters)
            throws IOException
    {
     ...
     */
    public List(of COSName) getFilters()
    {
        List(of COSName) retval = null;
        COSBase filters = stream.getFilters();
        if (filters instanceof COSName)
        {
            COSName name = (COSName) filters;
            retval = new COSArrayList(of COSName)(name, name, stream,
                    COSName.FILTER);
        } 
        else if (filters instanceof COSArray)
        {
            retval = (List(of COSName)) ((COSArray) filters).toList();
        }
        return retval;
    }
     ...
     */
    public void setFilters(List(of COSName) filters)
    {
     ...
     */
    public List(Of Object) getDecodeParms() throws IOException
    {
        List(Of Object) retval = null;
        ...
        if (dp instanceof COSDictionary)
        {
            ...
            retval = new COSArrayList(Of Object)(map, dp, stream,
                    COSName.DECODE_PARMS);
        } 
        else if (dp instanceof COSArray)
        {
            COSArray array = (COSArray) dp;
            List(Of Object) actuals = new ArrayList(Of Object)();
     ...
     * @return A list of all encoding filters to apply to this stream.
     */
    public List(Of String) getFileFilters()
    {
        ...
        {
            COSName name = (COSName) filters;
            retval = new COSArrayList(Of String)(name.getName(), name, stream,
                    COSName.F_FILTER);
        } 
        else if (filters instanceof COSArray)
        {
     ...
     *            The filters that are part of this stream.
     */
    public void setFileFilters(List(Of String) filters)
    {
     ...
     *             if there is an error retrieving the parameters.
     */
    public List(Of Object) getFileDecodeParams() throws IOException
    {
        List(Of Object) retval = null;
