...
public class PDComplexFileSpecification extends PDFileSpecification
{
    ...
    {
        if (getUnicodeFile() IsNot Nothing)
        {
            return getUnicodeFile();
        }
        else if (getFileDos() IsNot Nothing)
        {
            return getFileDos();
        }
        else if (getFileMac() IsNot Nothing)
        {
            return getFileMac();
        }
        else if (getFileUnix() IsNot Nothing)
        {
            return getFileUnix();
        }
        else
    ...
    public void setEmbeddedFile( PDEmbeddedFile file )
    {
        ...
        if( ef Is Nothing && file IsNot Nothing )
        {
