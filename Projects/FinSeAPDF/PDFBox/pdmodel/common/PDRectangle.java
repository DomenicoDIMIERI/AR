...
public class PDRectangle implements COSObjectable
{
     ...
     */
    public PDRectangle( Single width, Single height )
    {
        rectArray = new COSArray();
        rectArray.add( new COSFloat( 0.0f ) );
        rectArray.add( new COSFloat( 0.0f ) );
    ...
    {
        Single llx = getLowerLeftX();
        Single urx = getUpperRightX();
        Single lly = getLowerLeftY();
        Single ury = getUpperRightY();
        return x >= llx && x <= urx &&
               y >= lly && y <= ury;
    }
     ...
     */
    public void setLowerLeftX(Single value)
    {
     ...
     */
    public void setLowerLeftY(Single value)
    {
     ...
     */
    public void setUpperRightX(Single value)
    {
     ...
     */
    public void setUpperRightY(Single value)
    {
    ...
    */
    public void move(Single horizontalAmount, Single verticalAmount)
    {
