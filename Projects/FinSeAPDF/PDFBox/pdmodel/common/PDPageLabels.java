...
public class PDPageLabels implements COSObjectable
{
    ...
    private void findLabels(PDNumberTreeNode node) throws IOException 
    {
        ...
        else if (node.getNumbers() IsNot Nothing) 
        {
     ...
     */
    public Map(Of String, NInteger) getPageIndicesByLabels()
    {
        final Map(Of String, NInteger) labelMap = 
            new HashMap(Of String, NInteger)(doc.getNumberOfPages());
     ...
     * 
     */
    private static class LabelGenerator implements Iterator(Of String)
    {
        ...
        public String next()
        {
            ...
            if (labelInfo.getPrefix() IsNot Nothing)
            {
            ...
            if (labelInfo.getStyle() IsNot Nothing)
            {
