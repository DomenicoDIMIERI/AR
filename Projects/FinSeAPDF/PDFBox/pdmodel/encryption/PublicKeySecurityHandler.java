...
public class PublicKeySecurityHandler extends SecurityHandler
{
    ...
    throws CryptographyException, IOException
    {
	      ...
	      try
	      {
	          ...
	          if(!foundRecipient || envelopedData Is Nothing)
	          {
	          ...
	          encryptionKey = new byte[Me.keyLength/8];
	          System.arraycopy(mdResult, 0, encryptionKey, 0, Me.keyLength/8);
	      }
    ...
    public void prepareDocumentForEncryption(PDDocument doc) throws CryptographyException
    {
        ...
        try
        {
            ...
            Me.encryptionKey = new byte[Me.keyLength/8];
            System.arraycopy(mdResult, 0, Me.encryptionKey, 0, Me.keyLength/8);
