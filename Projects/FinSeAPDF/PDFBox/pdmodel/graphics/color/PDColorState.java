...
public class PDColorState implements Cloneable
{
    ...
    {
        if (color Is Nothing && colorSpaceValue.size() > 0)
        {
            color = createColor();
        }
        return color;
    ...
    {
        if (paint Is Nothing && pattern IsNot Nothing)
        {
    ...
    {
        Single() components = colorSpaceValue.toFloatArray();
        try
        {
            ...
            else if (PDLab.NAME.equals(csName))
            {
                ...
                Single() csComponents = colorSpace.getJavaColorSpace().toRGB(components);
            ...
            else
            {
                ...
                if (cs instanceof ICC_ColorSpace && override IsNot Nothing)
                {
     ...
     */
    public Single() getColorSpaceValue()
    {
     ...
     */
    public void setColorSpaceValue(Single() value)
    {
