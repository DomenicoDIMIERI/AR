...
public class PDDeviceN extends PDColorSpace
{
     ...
     */
    public List(Of String) getColorantNames()
    {
     ...
     */
    public void setColorantNames( List(Of String) names )
    {
    ...
    {
        if ( deviceNAttributes Is Nothing  && array.size() > DEVICEN_ATTRIBUTES) { // the DeviceN contains an attributes dictionary
     ...
     */
    public COSArray calculateColorValues(List(Of COSBase) tintValues) throws IOException
    {
