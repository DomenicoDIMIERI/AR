    ...
    public BufferedImage getRGBImage() throws IOException
    {
        ...
        try
        {
            ...
            else if (colorspace instanceof PDSeparation)
            {
                ...
                boolean invert = decode IsNot Nothing && decode.getInt(0) == 1;
