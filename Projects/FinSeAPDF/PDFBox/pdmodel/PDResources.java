...
public class PDResources implements COSObjectable
{
    ...
    private Map(Of String, PDXObject) xobjects = null;
    ...
    public void clear()
    {
        if (fonts IsNot Nothing)
        {
            fonts.clear();
            fonts = null;
        }
        if (fontMappings IsNot Nothing)
        {
            fontMappings.clear();
            fontMappings = null;
        }
        if (colorspaces IsNot Nothing)
        {
            colorspaces.clear();
            colorspaces = null;
        }
        if (xobjects IsNot Nothing)
        {
            xobjects.clear();
            xobjects = null;
        }
        if (xobjectMappings IsNot Nothing)
        {
            xobjectMappings.clear();
            xobjectMappings = null;
        }
        if (images IsNot Nothing)
        {
            images.clear();
            images = null;
        }
        if (graphicsStates IsNot Nothing)
        {
            graphicsStates.clear();
            graphicsStates = null;
        }
        if (patterns IsNot Nothing)
        {
            patterns.clear();
            patterns = null;
        }
        if (shadings IsNot Nothing)
        {
            shadings.clear();
            shadings = null;
        }
    ...
    public Map(Of String, PDXObject) getXObjects()
    {
        if (xobjects Is Nothing)
        {
            ...
            if (xobjectsDictionary Is Nothing)
            {
    ...
    {
        if (images Is Nothing)
        {
            Map(Of String, PDXObject) allXObjects = getXObjects();
            images = new HashMap<String, PDXObjectImage>();
            for (Map.Entry(Of String, PDXObject) entry : allXObjects.entrySet())
            {
     ...
     */
    public void setXObjects(Map(Of String, PDXObject) xobjectsValue)
    {
        xobjects = xobjectsValue;
        if (xobjectsValue IsNot Nothing)
        {
    ...
    public void setPatterns(Map<String, PDPatternResources> patternsValue)
    {
        ...
        if (patternsValue IsNot Nothing)
        {
    ...
    public void setShadings(Map<String, PDShadingResources> shadingsValue)
    {
        ...
        if (shadingsValue IsNot Nothing)
        {
