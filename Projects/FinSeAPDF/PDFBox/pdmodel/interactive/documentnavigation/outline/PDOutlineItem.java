...
public class PDOutlineItem extends PDOutlineNode
{
    ...
    public PDPage findDestinationPage( PDDocument doc ) throws IOException
    {
        ...
        if( rawDest Is Nothing )
        {
            ...
            else if( outlineAction Is Nothing )
            {
