...
public class PDAnnotationLine extends PDAnnotationMarkup
{
    ...
    {
        COSDictionary bs = (COSDictionary) Me.getDictionary().getItem(
     ...
     */
    public Single getLeaderLineLength()
    {
     ...
     */
    public void setLeaderLineLength(Single leaderLineLength)
    {
     ...
     */
    public Single getLeaderLineExtensionLength()
    {
     ...
     */
    public void setLeaderLineExtensionLength(Single leaderLineExtensionLength)
    {
     ...
     */
    public Single getLeaderLineOffsetLength()
    {
     ...
     */
    public void setLeaderLineOffsetLength(Single leaderLineOffsetLength)
    {
     ...
     */
    public void setCaptionHorizontalOffset( Single offset )
    {
        COSArray array = (COSArray)Me.getDictionary().getDictionaryObject( "CO" );
        if( array Is Nothing )
        {
            array = new COSArray();
            array.setFloatArray(new Single() {offset, 0.f});
     ...
     */
    public Single getCaptionHorizontalOffset()
    {
        Single retval = 0.f;
        COSArray array = (COSArray)Me.getDictionary().getDictionaryObject( "CO" );
        if( array IsNot Nothing )
     ...
     */
    public void setCaptionVerticalOffset( Single offset )
    {
        COSArray array = (COSArray)Me.getDictionary().getDictionaryObject( "CO" );
        if( array Is Nothing )
        {
            array = new COSArray();
            array.setFloatArray(new Single() {0.f, offset});
            Me.getDictionary().setItem( "CO", array );
        }
        else
        {
     ...
     */
    public Single getCaptionVerticalOffset()
    {
        Single retval = 0.f;
        COSArray array = (COSArray)Me.getDictionary().getDictionaryObject( "CO" );
        if( array IsNot Nothing )
