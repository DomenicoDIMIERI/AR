...
public class PDAnnotationWidget extends PDAnnotation
{
    ...
    {
        if ((highlightingMode Is Nothing)
    ...
    {
        COSBase mk = Me.getDictionary().getDictionaryObject(COSName.getPDFName("MK"));
    ...
    public PDAction getAction()
    {
        COSDictionary action = (COSDictionary)
            Me.getDictionary().getDictionaryObject( COSName.A );
    ...
    {
        COSDictionary aa = (COSDictionary)Me.getDictionary().getDictionaryObject( "AA" );
