...
public class PDAppearanceDictionary implements COSObjectable
{
     ...
     */
    public Map(Of String,PDAppearanceStream) getNormalAppearance()
    {
        ...
        Map(of String, PDAppearanceStream) actuals = new HashMap(of String, PDAppearanceStream)();
        Map(of String, PDAppearanceStream) retval = new COSDictionaryMap(of String, PDAppearanceStream)( actuals, map );
     ...
     */
    public void setNormalAppearance( Map(Of String,PDAppearanceStream) appearanceMap )
    {
     ...
     * @return A list of key(java.lang.String) value(PDAppearanceStream) pairs
     */
    public Map(Of String,PDAppearanceStream) getRolloverAppearance()
    {
        Map(Of String,PDAppearanceStream) retval = null;
     ...
     * @param appearanceMap The updated map with the appearance.
     */
    public void setRolloverAppearance( Map(Of String,PDAppearanceStream) appearanceMap )
    {
     ...
     * @return A list of key(java.lang.String) value(PDAppearanceStream) pairs
     */
    public Map(Of String,PDAppearanceStream) getDownAppearance()
    {
        Map(Of String,PDAppearanceStream) retval = null;
        ...
        else
        {
            ...
            COSDictionary map = (COSDictionary)ap;
            Map(of String, PDAppearanceStream) actuals =
                new HashMap(of String, PDAppearanceStream)();
            retval = new COSDictionaryMap(of String, PDAppearanceStream)( actuals, map );
            for( COSName asName : map.keySet() )
            {
                COSBase stream = map.getDictionaryObject( asName );
     ...
     * @param appearanceMap The updated map with the appearance.
     */
    public void setDownAppearance( Map(Of String,PDAppearanceStream) appearanceMap )
    {
