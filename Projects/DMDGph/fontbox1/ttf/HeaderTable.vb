Namespace org.fontbox.ttf
    ...
    Public Class HeaderTable
        ...
        ' */
        Public Function getCreated() As NDate
            Return created
        End Function
        ...
        ' */
        Public Sub setCreated(ByVal createdValue As NDate)
        ...
        ' */
        Public Function getModified() As NDate
            Return modified
        End Function
        ...
        ' */
        Public Sub setModified(ByVal modifiedValue As NDate)
