Namespace org.fontbox.ttf
    ...
    Public Class NameRecord
        ...
        Public PLATFORM_ENCODING_WINDOWS_UNICODE = 1
        ...
        Public NAME_FONT_FAMILY_NAME = 1
        Public NAME_FONT_SUB_FAMILY_NAME = 2
        Public NAME_UNIQUE_FONT_ID = 3
        Public NAME_FULL_FONT_NAME = 4
        Public NAME_VERSION = 5
        Public NAME_POSTSCRIPT_NAME = 6
        Public NAME_TRADEMARK = 7
