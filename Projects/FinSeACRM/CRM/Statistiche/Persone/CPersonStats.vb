...
Partial Public Class CustomerCalls
    ...
    Public Class CPersonStats
        ...
        Private m_DataProssimoRicontatto As Nullable(Of Date)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public ReadOnly Property DataAggiornamento As Date?
            Get
        ...
        Public ReadOnly Property DataUltimoContatto As Date?
            Get
                Return Calendar.Max(Me.DataUltimoContattoOk, Me.DataUltimoContattoNo)
            End Get
        End Property
        ...
        Protected Overrides Function LoadFromRecordset(reader As DBReader) As Boolean
            ...
            If (tmp <> "") Then
                Try
                    Me.m_CondizioniAttenzione.AddRange(XML.Utils.Serializer.Deserialize(tmp))
#If DEBUG Then
                    For Each c As CPersonWatchCond In Me.m_CondizioniAttenzione
                        If c Is Nothing Then
                            Me.m_CondizioniAttenzione = Nothing
                        End If
                    Next
#End If
        ...
        Public Sub AggiornaOperazione(ByVal source As Object, ByVal descrizione As String)
            Me.m_DataAggiornamento = Calendar.Now
            Me.m_DataUltimaOperazione = Calendar.Now
