...
Imports FinSeA.Net.Mail.Protocols.POP3
...
Namespace Net.Mail
    ...
    Public NotInheritable Class Pop3Client
        Inherits FinSeA.Net.Mail.GenericMailClient

        Public Shared ReadOnly DefaultPort As Integer = 110

        Private _client As TcpClient
        Private _clientStream As Stream
        Private m_Async As Boolean = False
        ...
        Private Sub Dele1(ByVal item As Pop3ListItem)
            ...
            End Using
        End Sub
        Public Overrides Sub Dele(item As MailMessageEx)
        ...
        Public Function RetrMimeEntity(ByVal item As Pop3ListItem) As MimeEntity
            ...
            Using command As New RetrCommand(Me, _clientStream, item.MessageId)
        ...
        Public Overrides Function GetMessagesList() As CCollection(Of MailMessageEx)
            ...
            Me.Stat()
            For Each item As FinSeA.Net.Mail.Protocols.POP3.Pop3ListItem In Me.List()
                Dim message As FinSeA.Net.Mail.MailMessageEx = Me.RetrMailMessageEx(item)
                ret.Add(message)
            Next
            Return ret
        End Function
